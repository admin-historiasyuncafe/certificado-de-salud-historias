...
`).replace(Ad,``)}function Md(e,t){return t=jd(t),jd(e)===t}function $(e,t,n,r,a,o){switch(n){case`children`:typeof r==`string`?t===`body`||t===`textarea`&&r===``||$t(e,r):(typeof r==`number`||typeof r==`bigint`)&&t!==`body`&&$t(e,``+r);break;case`className`:Lt(e,`class`,r);break;case`tabIndex`:Lt(e,`tabindex`,r);break;case`dir`:case`role`:case`viewBox`:case`width`:case`height`:Lt(e,n,r);break;case`style`:nn(e,r,o);break;case`data`:if(t!==`object`){Lt(e,`data`,r);break}case`src`:case`href`:if(r===``&&(t!==`a`||n!==`href`)){e.removeAttribute(n);break}if(r==null||typeof r==`function`||typeof r==`symbol`||typeof r==`boolean`){e.removeAttribute(n);break}r=sn(``+r),e.setAttribute(n,r);break;case`action`:case`formAction`:if(typeof r==`function`){e.setAttribute(n,`javascript:throw new Error('A React form was unexpectedly submitted. If you called form.submit() manually, consider using form.requestSubmit() instead. If you\\'re trying to use event.stopPropagation() in a submit event handler, consider also calling event.preventDefault().')`);break}else typeof o==`function`&&(n===`formAction`?(t!==`input`&&$(e,t,`name`,a.name,a,null),$(e,t,`formEncType`,a.formEncType,a,null),$(e,t,`formMethod`,a.formMethod,a,null),$(e,t,`formTarget`,a.formTarget,a,null)):($(e,t,`encType`,a.encType,a,null),$(e,t,`method`,a.method,a,null),$(e,t,`target`,a.target,a,null)));if(r==null||typeof r==`symbol`||typeof r==`boolean`){e.removeAttribute(n);break}r=sn(``+r),e.setAttribute(n,r);break;case`onClick`:r!=null&&(e.onclick=cn);break;case`onScroll`:r!=null&&Q(`scroll`,e);break;case`onScrollEnd`:r!=null&&Q(`scrollend`,e);break;case`dangerouslySetInnerHTML`:if(r!=null){if(typeof r!=`object`||!(`__html`in r))throw Error(i(61));if(n=r.__html,n!=null){if(a.children!=null)throw Error(i(60));e.innerHTML=n}}break;case`multiple`:e.multiple=r&&typeof r!=`function`&&typeof r!=`symbol`;break;case`muted`:e.muted=r&&typeof r!=`function`&&typeof r!=`symbol`;break;case`suppressContentEditableWarning`:case`suppressHydrationWarning`:case`defaultValue`:case`defaultChecked`:case`innerHTML`:case`ref`:break;case`autoFocus`:break;case`xlinkHref`:if(r==null||typeof r==`function`||typeof r==`boolean`||typeof r==`symbol`){e.removeAttribute(`xlink:href`);break}n=sn(``+r),e.setAttributeNS(`http://www.w3.org/1999/xlink`,`xlink:href`,n);break;case`contentEditable`:case`spellCheck`:case`draggable`:case`value`:case`autoReverse`:case`externalResourcesRequired`:case`focusable`:case`preserveAlpha`:r!=null&&typeof r!=`function`&&typeof r!=`symbol`?e.setAttribute(n,``+r):e.removeAttribute(n);break;case`inert`:case`allowFullScreen`:case`async`:case`autoPlay`:case`controls`:case`default`:case`defer`:case`disabled`:case`disablePictureInPicture`:case`disableRemotePlayback`:case`formNoValidate`:case`hidden`:case`loop`:case`noModule`:case`noValidate`:case`open`:case`playsInline`:case`readOnly`:case`required`:case`reversed`:case`scoped`:case`seamless`:case`itemScope`:r&&typeof r!=`function`&&typeof r!=`symbol`?e.setAttribute(n,``):e.removeAttribute(n);break;case`capture`:case`download`:!0===r?e.setAttribute(n,``):!1!==r&&r!=null&&typeof r!=`function`&&typeof r!=`symbol`?e.setAttribute(n,r):e.removeAttribute(n);break;case`cols`:case`rows`:case`size`:case`span`:r!=null&&typeof r!=`function`&&typeof r!=`symbol`&&!isNaN(r)&&1<=r?e.setAttribute(n,r):e.removeAttribute(n);break;case`rowSpan`:case`start`:r==null||typeof r==`function`||typeof r==`symbol`||isNaN(r)?e.removeAttribute(n):e.setAttribute(n,r);break;case`popover`:Q(`beforetoggle`,e),Q(`toggle`,e),It(e,`popover`,r);break;case`xlinkActuate`:Rt(e,`http://www.w3.org/1999/xlink`,`xlink:actuate`,r);break;case`xlinkArcrole`:Rt(e,`http://www.w3.org/1999/xlink`,`xlink:arcrole`,r);break;case`xlinkRole`:Rt(e,`http://www.w3.org/1999/xlink`,`xlink:role`,r);break;case`xlinkShow`:Rt(e,`http://www.w3.org/1999/xlink`,`xlink:show`,r);break;case`xlinkTitle`:Rt(e,`http://www.w3.org/1999/xlink`,`xlink:title`,r);break;case`xlinkType`:Rt(e,`http://www.w3.org/1999/xlink`,`xlink:type`,r);break;case`xmlBase`:Rt(e,`http://www.w3.org/XML/1998/namespace`,`xml:base`,r);break;case`xmlLang`:Rt(e,`http://www.w3.org/XML/1998/namespace`,`xml:lang`,r);break;case`xmlSpace`:Rt(e,`http://www.w3.org/XML/1998/namespace`,`xml:space`,r);break;case`is`:It(e,`is`,r);break;case`innerText`:case`textContent`:break;default:(!(2<n.length)||n[0]!==`o`&&n[0]!==`O`||n[1]!==`n`&&n[1]!==`N`)&&(n=an.get(n)||n,It(e,n,r))}}function Nd(e,t,n,r,a,o){switch(n){case`style`:nn(e,r,o);break;case`dangerouslySetInnerHTML`:if(r!=null){if(typeof r!=`object`||!(`__html`in r))throw Error(i(61));if(n=r.__html,n!=null){if(a.children!=null)throw Error(i(60));e.innerHTML=n}}break;case`children`:typeof r==`string`?$t(e,r):(typeof r==`number`||typeof r==`bigint`)&&$t(e,``+r);break;case`onScroll`:r!=null&&Q(`scroll`,e);break;case`onScrollEnd`:r!=null&&Q(`scrollend`,e);break;case`onClick`:r!=null&&(e.onclick=cn);break;case`suppressContentEditableWarning`:case`suppressHydrationWarning`:case`innerHTML`:case`ref`:break;case`innerText`:case`textContent`:break;default:if(!kt.hasOwnProperty(n))a:{if(n[0]===`o`&&n[1]===`n`&&(a=n.endsWith(`Capture`),t=n.slice(2,a?n.length-7:void 0),o=e[ht]||null,o=o==null?null:o[n],typeof o==`function`&&e.removeEventListener(t,o,a),typeof r==`function`)){typeof o!=`function`&&o!==null&&(n in e?e[n]=null:e.hasAttribute(n)&&e.removeAttribute(n)),e.addEventListener(t,r,a);break a}n in e?e[n]=r:!0===r?e.setAttribute(n,``):It(e,n,r)}}}function Pd(e,t,n){switch(t){case`div`:case`span`:case`svg`:case`path`:case`a`:case`g`:case`p`:case`li`:break;case`img`:Q(`error`,e),Q(`load`,e);var r=!1,a=!1,o;for(o in n)if(n.hasOwnProperty(o)){var s=n[o];if(s!=null)switch(o){case`src`:r=!0;break;case`srcSet`:a=!0;break;case`children`:case`dangerouslySetInnerHTML`:throw Error(i(137,t));default:$(e,t,o,s,n,null)}}a&&$(e,t,`srcSet`,n.srcSet,n,null),r&&$(e,t,`src`,n.src,n,null);return;case`input`:Q(`invalid`,e);var c=o=s=a=null,l=null,u=null;for(r in n)if(n.hasOwnProperty(r)){var d=n[r];if(d!=null)switch(r){case`name`:a=d;break;case`type`:s=d;break;case`checked`:l=d;break;case`defaultChecked`:u=d;break;case`value`:o=d;break;case`defaultValue`:c=d;break;case`children`:case`dangerouslySetInnerHTML`:if(d!=null)throw Error(i(137,t));break;default:$(e,t,r,d,n,null)}}Jt(e,o,c,l,u,s,a,!1);return;case`select`:for(a in Q(`invalid`,e),r=s=o=null,n)if(n.hasOwnProperty(a)&&(c=n[a],c!=null))switch(a){case`value`:o=c;break;case`defaultValue`:s=c;break;case`multiple`:r=c;default:$(e,t,a,c,n,null)}t=o,n=s,e.multiple=!!r,t==null?n!=null&&Xt(e,!!r,n,!0):Xt(e,!!r,t,!1);return;case`textarea`:for(s in Q(`invalid`,e),o=a=r=null,n)if(n.hasOwnProperty(s)&&(c=n[s],c!=null))switch(s){case`value`:r=c;break;case`defaultValue`:a=c;break;case`children`:o=c;break;case`dangerouslySetInnerHTML`:if(c!=null)throw Error(i(91));break;default:$(e,t,s,c,n,null)}Qt(e,r,a,o);return;case`option`:for(l in n)if(n.hasOwnProperty(l)&&(r=n[l],r!=null))switch(l){case`selected`:e.selected=r&&typeof r!=`function`&&typeof r!=`symbol`;break;default:$(e,t,l,r,n,null)}return;case`dialog`:Q(`beforetoggle`,e),Q(`toggle`,e),Q(`cancel`,e),Q(`close`,e);break;case`iframe`:case`object`:Q(`load`,e);break;case`video`:case`audio`:for(r=0;r<_d.length;r++)Q(_d[r],e);break;case`image`:Q(`error`,e),Q(`load`,e);break;case`details`:Q(`toggle`,e);break;case`embed`:case`source`:case`link`:Q(`error`,e),Q(`load`,e);case`area`:case`base`:case`br`:case`col`:case`hr`:case`keygen`:case`meta`:case`param`:case`track`:case`wbr`:case`menuitem`:for(u in n)if(n.hasOwnProperty(u)&&(r=n[u],r!=null))switch(u){case`children`:case`dangerouslySetInnerHTML`:throw Error(i(137,t));default:$(e,t,u,r,n,null)}return;default:if(rn(t)){for(d in n)n.hasOwnProperty(d)&&(r=n[d],r!==void 0&&Nd(e,t,d,r,n,void 0));return}}for(c in n)n.hasOwnProperty(c)&&(r=n[c],r!=null&&$(e,t,c,r,n,null))}function Fd(e,t,n,r){switch(t){case`div`:case`span`:case`svg`:case`path`:case`a`:case`g`:case`p`:case`li`:break;case`input`:var a=null,o=null,s=null,c=null,l=null,u=null,d=null;for(m in n){var f=n[m];if(n.hasOwnProperty(m)&&f!=null)switch(m){case`checked`:break;case`value`:break;case`defaultValue`:l=f;default:r.hasOwnProperty(m)||$(e,t,m,null,r,f)}}for(var p in r){var m=r[p];if(f=n[p],r.hasOwnProperty(p)&&(m!=null||f!=null))switch(p){case`type`:o=m;break;case`name`:a=m;break;case`checked`:u=m;break;case`defaultChecked`:d=m;break;case`value`:s=m;break;case`defaultValue`:c=m;break;case`children`:case`dangerouslySetInnerHTML`:if(m!=null)throw Error(i(137,t));break;default:m!==f&&$(e,t,p,m,r,f)}}qt(e,s,c,l,u,d,o,a);return;case`select`:for(o in m=s=c=p=null,n)if(l=n[o],n.hasOwnProperty(o)&&l!=null)switch(o){case`value`:break;case`multiple`:m=l;default:r.hasOwnProperty(o)||$(e,t,o,null,r,l)}for(a in r)if(o=r[a],l=n[a],r.hasOwnProperty(a)&&(o!=null||l!=null))switch(a){case`value`:p=o;break;case`defaultValue`:c=o;break;case`multiple`:s=o;default:o!==l&&$(e,t,a,o,r,l)}t=c,n=s,r=m,p==null?!!r!=!!n&&(t==null?Xt(e,!!n,n?[]:``,!1):Xt(e,!!n,t,!0)):Xt(e,!!n,p,!1);return;case`textarea`:for(c in m=p=null,n)if(a=n[c],n.hasOwnProperty(c)&&a!=null&&!r.hasOwnProperty(c))switch(c){case`value`:break;case`children`:break;default:$(e,t,c,null,r,a)}for(s in r)if(a=r[s],o=n[s],r.hasOwnProperty(s)&&(a!=null||o!=null))switch(s){case`value`:p=a;break;case`defaultValue`:m=a;break;case`children`:break;case`dangerouslySetInnerHTML`:if(a!=null)throw Error(i(91));break;default:a!==o&&$(e,t,s,a,r,o)}Zt(e,p,m);return;case`option`:for(var h in n)if(p=n[h],n.hasOwnProperty(h)&&p!=null&&!r.hasOwnProperty(h))switch(h){case`selected`:e.selected=!1;break;default:$(e,t,h,null,r,p)}for(l in r)if(p=r[l],m=n[l],r.hasOwnProperty(l)&&p!==m&&(p!=null||m!=null))switch(l){case`selected`:e.selected=p&&typeof p!=`function`&&typeof p!=`symbol`;break;default:$(e,t,l,p,r,m)}return;case`img`:case`link`:case`area`:case`base`:case`br`:case`col`:case`embed`:case`hr`:case`keygen`:case`meta`:case`param`:case`source`:case`track`:case`wbr`:case`menuitem`:for(var g in n)p=n[g],n.hasOwnProperty(g)&&p!=null&&!r.hasOwnProperty(g)&&$(e,t,g,null,r,p);for(u in r)if(p=r[u],m=n[u],r.hasOwnProperty(u)&&p!==m&&(p!=null||m!=null))switch(u){case`children`:case`dangerouslySetInnerHTML`:if(p!=null)throw Error(i(137,t));break;default:$(e,t,u,p,r,m)}return;default:if(rn(t)){for(var _ in n)p=n[_],n.hasOwnProperty(_)&&p!==void 0&&!r.hasOwnProperty(_)&&Nd(e,t,_,void 0,r,p);for(d in r)p=r[d],m=n[d],!r.hasOwnProperty(d)||p===m||p===void 0&&m===void 0||Nd(e,t,d,p,r,m);return}}for(var v in n)p=n[v],n.hasOwnProperty(v)&&p!=null&&!r.hasOwnProperty(v)&&$(e,t,v,null,r,p);for(f in r)p=r[f],m=n[f],!r.hasOwnProperty(f)||p===m||p==null&&m==null||$(e,t,f,p,r,m)}function Id(e){switch(e){case`css`:case`script`:case`font`:case`img`:case`image`:case`input`:case`link`:return!0;default:return!1}}function Ld(){if(typeof performance.getEntriesByType==`function`){for(var e=0,t=0,n=performance.getEntriesByType(`resource`),r=0;r<n.length;r++){var i=n[r],a=i.transferSize,o=i.initiatorType,s=i.duration;if(a&&s&&Id(o)){for(o=0,s=i.responseEnd,r+=1;r<n.length;r++){var c=n[r],l=c.startTime;if(l>s)break;var u=c.transferSize,d=c.initiatorType;u&&Id(d)&&(c=c.responseEnd,o+=u*(c<s?1:(s-l)/(c-l)))}if(--r,t+=8*(a+o)/(i.duration/1e3),e++,10<e)break}}if(0<e)return t/e/1e6}return navigator.connection&&(e=navigator.connection.downlink,typeof e==`number`)?e:5}var Rd=null,zd=null;function Bd(e){return e.nodeType===9?e:e.ownerDocument}function Vd(e){switch(e){case`http://www.w3.org/2000/svg`:return 1;case`http://www.w3.org/1998/Math/MathML`:return 2;default:return 0}}function Hd(e,t){if(e===0)switch(t){case`svg`:return 1;case`math`:return 2;default:return 0}return e===1&&t===`foreignObject`?0:e}function Ud(e,t){return e===`textarea`||e===`noscript`||typeof t.children==`string`||typeof t.children==`number`||typeof t.children==`bigint`||typeof t.dangerouslySetInnerHTML==`object`&&t.dangerouslySetInnerHTML!==null&&t.dangerouslySetInnerHTML.__html!=null}var Wd=null;function Gd(){var e=window.event;return e&&e.type===`popstate`?e===Wd?!1:(Wd=e,!0):(Wd=null,!1)}var Kd=typeof setTimeout==`function`?setTimeout:void 0,qd=typeof clearTimeout==`function`?clearTimeout:void 0,Jd=typeof Promise==`function`?Promise:void 0,Yd=typeof queueMicrotask==`function`?queueMicrotask:Jd===void 0?Kd:function(e){return Jd.resolve(null).then(e).catch(Xd)};function Xd(e){setTimeout(function(){throw e})}function Zd(e){return e===`head`}function Qd(e,t){var n=t,r=0;do{var i=n.nextSibling;if(e.removeChild(n),i&&i.nodeType===8)if(n=i.data,n===`/$`||n===`/&`){if(r===0){e.removeChild(i),Np(t);return}r--}else if(n===`$`||n===`$?`||n===`$~`||n===`$!`||n===`&`)r++;else if(n===`html`)pf(e.ownerDocument.documentElement);else if(n===`head`){n=e.ownerDocument.head,pf(n);for(var a=n.firstChild;a;){var o=a.nextSibling,s=a.nodeName;a[xt]||s===`SCRIPT`||s===`STYLE`||s===`LINK`&&a.rel.toLowerCase()===`stylesheet`||n.removeChild(a),a=o}}else n===`body`&&pf(e.ownerDocument.body);n=i}while(n);Np(t)}function $d(e,t){var n=e;e=0;do{var r=n.nextSibling;if(n.nodeType===1?t?(n._stashedDisplay=n.style.display,n.style.display=`none`):(n.style.display=n._stashedDisplay||``,n.getAttribute(`style`)===``&&n.removeAttribute(`style`)):n.nodeType===3&&(t?(n._stashedText=n.nodeValue,n.nodeValue=``):n.nodeValue=n._stashedText||``),r&&r.nodeType===8)if(n=r.data,n===`/$`){if(e===0)break;e--}else n!==`$`&&n!==`$?`&&n!==`$~`&&n!==`$!`||e++;n=r}while(n)}function ef(e){var t=e.firstChild;for(t&&t.nodeType===10&&(t=t.nextSibling);t;){var n=t;switch(t=t.nextSibling,n.nodeName){case`HTML`:case`HEAD`:case`BODY`:ef(n),St(n);continue;case`SCRIPT`:case`STYLE`:continue;case`LINK`:if(n.rel.toLowerCase()===`stylesheet`)continue}e.removeChild(n)}}function tf(e,t,n,r){for(;e.nodeType===1;){var i=n;if(e.nodeName.toLowerCase()!==t.toLowerCase()){if(!r&&(e.nodeName!==`INPUT`||e.type!==`hidden`))break}else if(!r)if(t===`input`&&e.type===`hidden`){var a=i.name==null?null:``+i.name;if(i.type===`hidden`&&e.getAttribute(`name`)===a)return e}else return e;else if(!e[xt])switch(t){case`meta`:if(!e.hasAttribute(`itemprop`))break;return e;case`link`:if(a=e.getAttribute(`rel`),a===`stylesheet`&&e.hasAttribute(`data-precedence`)||a!==i.rel||e.getAttribute(`href`)!==(i.href==null||i.href===``?null:i.href)||e.getAttribute(`crossorigin`)!==(i.crossOrigin==null?null:i.crossOrigin)||e.getAttribute(`title`)!==(i.title==null?null:i.title))break;return e;case`style`:if(e.hasAttribute(`data-precedence`))break;return e;case`script`:if(a=e.getAttribute(`src`),(a!==(i.src==null?null:i.src)||e.getAttribute(`type`)!==(i.type==null?null:i.type)||e.getAttribute(`crossorigin`)!==(i.crossOrigin==null?null:i.crossOrigin))&&a&&e.hasAttribute(`async`)&&!e.hasAttribute(`itemprop`))break;return e;default:return e}if(e=cf(e.nextSibling),e===null)break}return null}function nf(e,t,n){if(t===``)return null;for(;e.nodeType!==3;)if((e.nodeType!==1||e.nodeName!==`INPUT`||e.type!==`hidden`)&&!n||(e=cf(e.nextSibling),e===null))return null;return e}function rf(e,t){for(;e.nodeType!==8;)if((e.nodeType!==1||e.nodeName!==`INPUT`||e.type!==`hidden`)&&!t||(e=cf(e.nextSibling),e===null))return null;return e}function af(e){return e.data===`$?`||e.data===`$~`}function of(e){return e.data===`$!`||e.data===`$?`&&e.ownerDocument.readyState!==`loading`}function sf(e,t){var n=e.ownerDocument;if(e.data===`$~`)e._reactRetry=t;else if(e.data!==`$?`||n.readyState!==`loading`)t();else{var r=function(){t(),n.removeEventListener(`DOMContentLoaded`,r)};n.addEventListener(`DOMContentLoaded`,r),e._reactRetry=r}}function cf(e){for(;e!=null;e=e.nextSibling){var t=e.nodeType;if(t===1||t===3)break;if(t===8){if(t=e.data,t===`$`||t===`$!`||t===`$?`||t===`$~`||t===`&`||t===`F!`||t===`F`)break;if(t===`/$`||t===`/&`)return null}}return e}var lf=null;function uf(e){e=e.nextSibling;for(var t=0;e;){if(e.nodeType===8){var n=e.data;if(n===`/$`||n===`/&`){if(t===0)return cf(e.nextSibling);t--}else n!==`$`&&n!==`$!`&&n!==`$?`&&n!==`$~`&&n!==`&`||t++}e=e.nextSibling}return null}function df(e){e=e.previousSibling;for(var t=0;e;){if(e.nodeType===8){var n=e.data;if(n===`$`||n===`$!`||n===`$?`||n===`$~`||n===`&`){if(t===0)return e;t--}else n!==`/$`&&n!==`/&`||t++}e=e.previousSibling}return null}function ff(e,t,n){switch(t=Bd(n),e){case`html`:if(e=t.documentElement,!e)throw Error(i(452));return e;case`head`:if(e=t.head,!e)throw Error(i(453));return e;case`body`:if(e=t.body,!e)throw Error(i(454));return e;default:throw Error(i(451))}}function pf(e){for(var t=e.attributes;t.length;)e.removeAttributeNode(t[0]);St(e)}var mf=new Map,hf=new Set;function gf(e){return typeof e.getRootNode==`function`?e.getRootNode():e.nodeType===9?e:e.ownerDocument}var _f=E.d;E.d={f:vf,r:yf,D:Sf,C:Cf,L:wf,m:Tf,X:Df,S:Ef,M:Of};function vf(){var e=_f.f(),t=bu();return e||t}function yf(e){var t=wt(e);t!==null&&t.tag===5&&t.type===`form`?As(t):_f.r(e)}var bf=typeof document>`u`?null:document;function xf(e,t,n){var r=bf;if(r&&typeof t==`string`&&t){var i=Kt(t);i=`link[rel="`+e+`"][href="`+i+`"]`,typeof n==`string`&&(i+=`[crossorigin="`+n+`"]`),hf.has(i)||(hf.add(i),e={rel:e,crossOrigin:n,href:t},r.querySelector(i)===null&&(t=r.createElement(`link`),Pd(t,`link`,e),Dt(t),r.head.appendChild(t)))}}function Sf(e){_f.D(e),xf(`dns-prefetch`,e,null)}function Cf(e,t){_f.C(e,t),xf(`preconnect`,e,t)}function wf(e,t,n){_f.L(e,t,n);var r=bf;if(r&&e&&t){var i=`link[rel="preload"][as="`+Kt(t)+`"]`;t===`image`&&n&&n.imageSrcSet?(i+=`[imagesrcset="`+Kt(n.imageSrcSet)+`"]`,typeof n.imageSizes==`string`&&(i+=`[imagesizes="`+Kt(n.imageSizes)+`"]`)):i+=`[href="`+Kt(e)+`"]`;var a=i;switch(t){case`style`:a=Af(e);break;case`script`:a=Pf(e)}mf.has(a)||(e=h({rel:`preload`,href:t===`image`&&n&&n.imageSrcSet?void 0:e,as:t},n),mf.set(a,e),r.querySelector(i)!==null||t===`style`&&r.querySelector(jf(a))||t===`script`&&r.querySelector(Ff(a))||(t=r.createElement(`link`),Pd(t,`link`,e),Dt(t),r.head.appendChild(t)))}}function Tf(e,t){_f.m(e,t);var n=bf;if(n&&e){var r=t&&typeof t.as==`string`?t.as:`script`,i=`link[rel="modulepreload"][as="`+Kt(r)+`"][href="`+Kt(e)+`"]`,a=i;switch(r){case`audioworklet`:case`paintworklet`:case`serviceworker`:case`sharedworker`:case`worker`:case`script`:a=Pf(e)}if(!mf.has(a)&&(e=h({rel:`modulepreload`,href:e},t),mf.set(a,e),n.querySelector(i)===null)){switch(r){case`audioworklet`:case`paintworklet`:case`serviceworker`:case`sharedworker`:case`worker`:case`script`:if(n.querySelector(Ff(a)))return}r=n.createElement(`link`),Pd(r,`link`,e),Dt(r),n.head.appendChild(r)}}}function Ef(e,t,n){_f.S(e,t,n);var r=bf;if(r&&e){var i=Et(r).hoistableStyles,a=Af(e);t||=`default`;var o=i.get(a);if(!o){var s={loading:0,preload:null};if(o=r.querySelector(jf(a)))s.loading=5;else{e=h({rel:`stylesheet`,href:e,"data-precedence":t},n),(n=mf.get(a))&&Rf(e,n);var c=o=r.createElement(`link`);Dt(c),Pd(c,`link`,e),c._p=new Promise(function(e,t){c.onload=e,c.onerror=t}),c.addEventListener(`load`,function(){s.loading|=1}),c.addEventListener(`error`,function(){s.loading|=2}),s.loading|=4,Lf(o,t,r)}o={type:`stylesheet`,instance:o,count:1,state:s},i.set(a,o)}}}function Df(e,t){_f.X(e,t);var n=bf;if(n&&e){var r=Et(n).hoistableScripts,i=Pf(e),a=r.get(i);a||(a=n.querySelector(Ff(i)),a||(e=h({src:e,async:!0},t),(t=mf.get(i))&&zf(e,t),a=n.createElement(`script`),Dt(a),Pd(a,`link`,e),n.head.appendChild(a)),a={type:`script`,instance:a,count:1,state:null},r.set(i,a))}}function Of(e,t){_f.M(e,t);var n=bf;if(n&&e){var r=Et(n).hoistableScripts,i=Pf(e),a=r.get(i);a||(a=n.querySelector(Ff(i)),a||(e=h({src:e,async:!0,type:`module`},t),(t=mf.get(i))&&zf(e,t),a=n.createElement(`script`),Dt(a),Pd(a,`link`,e),n.head.appendChild(a)),a={type:`script`,instance:a,count:1,state:null},r.set(i,a))}}function kf(e,t,n,r){var a=(a=_e.current)?gf(a):null;if(!a)throw Error(i(446));switch(e){case`meta`:case`title`:return null;case`style`:return typeof n.precedence==`string`&&typeof n.href==`string`?(t=Af(n.href),n=Et(a).hoistableStyles,r=n.get(t),r||(r={type:`style`,instance:null,count:0,state:null},n.set(t,r)),r):{type:`void`,instance:null,count:0,state:null};case`link`:if(n.rel===`stylesheet`&&typeof n.href==`string`&&typeof n.precedence==`string`){e=Af(n.href);var o=Et(a).hoistableStyles,s=o.get(e);if(s||(a=a.ownerDocument||a,s={type:`stylesheet`,instance:null,count:0,state:{loading:0,preload:null}},o.set(e,s),(o=a.querySelector(jf(e)))&&!o._p&&(s.instance=o,s.state.loading=5),mf.has(e)||(n={rel:`preload`,as:`style`,href:n.href,crossOrigin:n.crossOrigin,integrity:n.integrity,media:n.media,hrefLang:n.hrefLang,referrerPolicy:n.referrerPolicy},mf.set(e,n),o||Nf(a,e,n,s.state))),t&&r===null)throw Error(i(528,``));return s}if(t&&r!==null)throw Error(i(529,``));return null;case`script`:return t=n.async,n=n.src,typeof n==`string`&&t&&typeof t!=`function`&&typeof t!=`symbol`?(t=Pf(n),n=Et(a).hoistableScripts,r=n.get(t),r||(r={type:`script`,instance:null,count:0,state:null},n.set(t,r)),r):{type:`void`,instance:null,count:0,state:null};default:throw Error(i(444,e))}}function Af(e){return`href="`+Kt(e)+`"`}function jf(e){return`link[rel="stylesheet"][`+e+`]`}function Mf(e){return h({},e,{"data-precedence":e.precedence,precedence:null})}function Nf(e,t,n,r){e.querySelector(`link[rel="preload"][as="style"][`+t+`]`)?r.loading=1:(t=e.createElement(`link`),r.preload=t,t.addEventListener(`load`,function(){return r.loading|=1}),t.addEventListener(`error`,function(){return r.loading|=2}),Pd(t,`link`,n),Dt(t),e.head.appendChild(t))}function Pf(e){return`[src="`+Kt(e)+`"]`}function Ff(e){return`script[async]`+e}function If(e,t,n){if(t.count++,t.instance===null)switch(t.type){case`style`:var r=e.querySelector(`style[data-href~="`+Kt(n.href)+`"]`);if(r)return t.instance=r,Dt(r),r;var a=h({},n,{"data-href":n.href,"data-precedence":n.precedence,href:null,precedence:null});return r=(e.ownerDocument||e).createElement(`style`),Dt(r),Pd(r,`style`,a),Lf(r,n.precedence,e),t.instance=r;case`stylesheet`:a=Af(n.href);var o=e.querySelector(jf(a));if(o)return t.state.loading|=4,t.instance=o,Dt(o),o;r=Mf(n),(a=mf.get(a))&&Rf(r,a),o=(e.ownerDocument||e).createElement(`link`),Dt(o);var s=o;return s._p=new Promise(function(e,t){s.onload=e,s.onerror=t}),Pd(o,`link`,r),t.state.loading|=4,Lf(o,n.precedence,e),t.instance=o;case`script`:return o=Pf(n.src),(a=e.querySelector(Ff(o)))?(t.instance=a,Dt(a),a):(r=n,(a=mf.get(o))&&(r=h({},n),zf(r,a)),e=e.ownerDocument||e,a=e.createElement(`script`),Dt(a),Pd(a,`link`,r),e.head.appendChild(a),t.instance=a);case`void`:return null;default:throw Error(i(443,t.type))}else t.type===`stylesheet`&&!(t.state.loading&4)&&(r=t.instance,t.state.loading|=4,Lf(r,n.precedence,e));return t.instance}function Lf(e,t,n){for(var r=n.querySelectorAll(`link[rel="stylesheet"][data-precedence],style[data-precedence]`),i=r.length?r[r.length-1]:null,a=i,o=0;o<r.length;o++){var s=r[o];if(s.dataset.precedence===t)a=s;else if(a!==i)break}a?a.parentNode.insertBefore(e,a.nextSibling):(t=n.nodeType===9?n.head:n,t.insertBefore(e,t.firstChild))}function Rf(e,t){e.crossOrigin??=t.crossOrigin,e.referrerPolicy??=t.referrerPolicy,e.title??=t.title}function zf(e,t){e.crossOrigin??=t.crossOrigin,e.referrerPolicy??=t.referrerPolicy,e.integrity??=t.integrity}var Bf=null;function Vf(e,t,n){if(Bf===null){var r=new Map,i=Bf=new Map;i.set(n,r)}else i=Bf,r=i.get(n),r||(r=new Map,i.set(n,r));if(r.has(e))return r;for(r.set(e,null),n=n.getElementsByTagName(e),i=0;i<n.length;i++){var a=n[i];if(!(a[xt]||a[mt]||e===`link`&&a.getAttribute(`rel`)===`stylesheet`)&&a.namespaceURI!==`http://www.w3.org/2000/svg`){var o=a.getAttribute(t)||``;o=e+o;var s=r.get(o);s?s.push(a):r.set(o,[a])}}return r}function Hf(e,t,n){e=e.ownerDocument||e,e.head.insertBefore(n,t===`title`?e.querySelector(`head > title`):null)}function Uf(e,t,n){if(n===1||t.itemProp!=null)return!1;switch(e){case`meta`:case`title`:return!0;case`style`:if(typeof t.precedence!=`string`||typeof t.href!=`string`||t.href===``)break;return!0;case`link`:if(typeof t.rel!=`string`||typeof t.href!=`string`||t.href===``||t.onLoad||t.onError)break;switch(t.rel){case`stylesheet`:return e=t.disabled,typeof t.precedence==`string`&&e==null;default:return!0}case`script`:if(t.async&&typeof t.async!=`function`&&typeof t.async!=`symbol`&&!t.onLoad&&!t.onError&&t.src&&typeof t.src==`string`)return!0}return!1}function Wf(e){return!(e.type===`stylesheet`&&!(e.state.loading&3))}function Gf(e,t,n,r){if(n.type===`stylesheet`&&(typeof r.media!=`string`||!1!==matchMedia(r.media).matches)&&!(n.state.loading&4)){if(n.instance===null){var i=Af(r.href),a=t.querySelector(jf(i));if(a){t=a._p,typeof t==`object`&&t&&typeof t.then==`function`&&(e.count++,e=Jf.bind(e),t.then(e,e)),n.state.loading|=4,n.instance=a,Dt(a);return}a=t.ownerDocument||t,r=Mf(r),(i=mf.get(i))&&Rf(r,i),a=a.createElement(`link`),Dt(a);var o=a;o._p=new Promise(function(e,t){o.onload=e,o.onerror=t}),Pd(a,`link`,r),n.instance=a}e.stylesheets===null&&(e.stylesheets=new Map),e.stylesheets.set(n,t),(t=n.state.preload)&&!(n.state.loading&3)&&(e.count++,n=Jf.bind(e),t.addEventListener(`load`,n),t.addEventListener(`error`,n))}}var Kf=0;function qf(e,t){return e.stylesheets&&e.count===0&&Xf(e,e.stylesheets),0<e.count||0<e.imgCount?function(n){var r=setTimeout(function(){if(e.stylesheets&&Xf(e,e.stylesheets),e.unsuspend){var t=e.unsuspend;e.unsuspend=null,t()}},6e4+t);0<e.imgBytes&&Kf===0&&(Kf=62500*Ld());var i=setTimeout(function(){if(e.waitingForImages=!1,e.count===0&&(e.stylesheets&&Xf(e,e.stylesheets),e.unsuspend)){var t=e.unsuspend;e.unsuspend=null,t()}},(e.imgBytes>Kf?50:800)+t);return e.unsuspend=n,function(){e.unsuspend=null,clearTimeout(r),clearTimeout(i)}}:null}function Jf(){if(this.count--,this.count===0&&(this.imgCount===0||!this.waitingForImages)){if(this.stylesheets)Xf(this,this.stylesheets);else if(this.unsuspend){var e=this.unsuspend;this.unsuspend=null,e()}}}var Yf=null;function Xf(e,t){e.stylesheets=null,e.unsuspend!==null&&(e.count++,Yf=new Map,t.forEach(Zf,e),Yf=null,Jf.call(e))}function Zf(e,t){if(!(t.state.loading&4)){var n=Yf.get(e);if(n)var r=n.get(null);else{n=new Map,Yf.set(e,n);for(var i=e.querySelectorAll(`link[data-precedence],style[data-precedence]`),a=0;a<i.length;a++){var o=i[a];(o.nodeName===`LINK`||o.getAttribute(`media`)!==`not all`)&&(n.set(o.dataset.precedence,o),r=o)}r&&n.set(null,r)}i=t.instance,o=i.getAttribute(`data-precedence`),a=n.get(o)||r,a===r&&n.set(null,i),n.set(o,i),this.count++,r=Jf.bind(this),i.addEventListener(`load`,r),i.addEventListener(`error`,r),a?a.parentNode.insertBefore(i,a.nextSibling):(e=e.nodeType===9?e.head:e,e.insertBefore(i,e.firstChild)),t.state.loading|=4}}var Qf={$$typeof:S,Provider:null,Consumer:null,_currentValue:de,_currentValue2:de,_threadCount:0};function $f(e,t,n,r,i,a,o,s,c){this.tag=1,this.containerInfo=e,this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.callbackNode=this.next=this.pendingContext=this.context=this.cancelPendingCommit=null,this.callbackPriority=0,this.expirationTimes=rt(-1),this.entangledLanes=this.shellSuspendCounter=this.errorRecoveryDisabledLanes=this.expiredLanes=this.warmLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=rt(0),this.hiddenUpdates=rt(null),this.identifierPrefix=r,this.onUncaughtError=i,this.onCaughtError=a,this.onRecoverableError=o,this.pooledCache=null,this.pooledCacheLanes=0,this.formState=c,this.incompleteTransitions=new Map}function ep(e,t,n,r,i,a,o,s,c,l,u,d){return e=new $f(e,t,n,o,c,l,u,d,s),t=1,!0===a&&(t|=24),a=gi(3,null,null,t),e.current=a,a.stateNode=e,t=ma(),t.refCount++,e.pooledCache=t,t.refCount++,a.memoizedState={element:r,isDehydrated:n,cache:t},qa(a),e}function tp(e){return e?(e=mi,e):mi}function np(e,t,n,r,i,a){i=tp(i),r.context===null?r.context=i:r.pendingContext=i,r=Ya(t),r.payload={element:n},a=a===void 0?null:a,a!==null&&(r.callback=a),n=Xa(e,r,t),n!==null&&(hu(n,e,t),Za(n,e,t))}function rp(e,t){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var n=e.retryLane;e.retryLane=n!==0&&n<t?n:t}}function ip(e,t){rp(e,t),(e=e.alternate)&&rp(e,t)}function ap(e){if(e.tag===13||e.tag===31){var t=di(e,67108864);t!==null&&hu(t,e,67108864),ip(e,67108864)}}function op(e){if(e.tag===13||e.tag===31){var t=pu();t=lt(t);var n=di(e,t);n!==null&&hu(n,e,t),ip(e,t)}}var sp=!0;function cp(e,t,n,r){var i=T.T;T.T=null;var a=E.p;try{E.p=2,up(e,t,n,r)}finally{E.p=a,T.T=i}}function lp(e,t,n,r){var i=T.T;T.T=null;var a=E.p;try{E.p=8,up(e,t,n,r)}finally{E.p=a,T.T=i}}function up(e,t,n,r){if(sp){var i=dp(r);if(i===null)wd(e,t,r,fp,n),Cp(e,r);else if(Tp(i,e,t,n,r))r.stopPropagation();else if(Cp(e,r),t&4&&-1<Sp.indexOf(e)){for(;i!==null;){var a=wt(i);if(a!==null)switch(a.tag){case 3:if(a=a.stateNode,a.current.memoizedState.isDehydrated){var o=Qe(a.pendingLanes);if(o!==0){var s=a;for(s.pendingLanes|=2,s.entangledLanes|=2;o;){var c=1<<31-Ge(o);s.entanglements[1]|=c,o&=~c}rd(a),!(W&6)&&(nu=k()+500,id(0,!1))}}break;case 31:case 13:s=di(a,2),s!==null&&hu(s,a,2),bu(),ip(a,2)}if(a=dp(r),a===null&&wd(e,t,r,fp,n),a===i)break;i=a}i!==null&&r.stopPropagation()}else wd(e,t,r,null,n)}}function dp(e){return e=un(e),pp(e)}var fp=null;function pp(e){if(fp=null,e=Ct(e),e!==null){var t=o(e);if(t===null)e=null;else{var n=t.tag;if(n===13){if(e=s(t),e!==null)return e;e=null}else if(n===31){if(e=c(t),e!==null)return e;e=null}else if(n===3){if(t.stateNode.current.memoizedState.isDehydrated)return t.tag===3?t.stateNode.containerInfo:null;e=null}else t!==e&&(e=null)}}return fp=e,null}function mp(e){switch(e){case`beforetoggle`:case`cancel`:case`click`:case`close`:case`contextmenu`:case`copy`:case`cut`:case`auxclick`:case`dblclick`:case`dragend`:case`dragstart`:case`drop`:case`focusin`:case`focusout`:case`input`:case`invalid`:case`keydown`:case`keypress`:case`keyup`:case`mousedown`:case`mouseup`:case`paste`:case`pause`:case`play`:case`pointercancel`:case`pointerdown`:case`pointerup`:case`ratechange`:case`reset`:case`resize`:case`seeked`:case`submit`:case`toggle`:case`touchcancel`:case`touchend`:case`touchstart`:case`volumechange`:case`change`:case`selectionchange`:case`textInput`:case`compositionstart`:case`compositionend`:case`compositionupdate`:case`beforeblur`:case`afterblur`:case`beforeinput`:case`blur`:case`fullscreenchange`:case`focus`:case`hashchange`:case`popstate`:case`select`:case`selectstart`:return 2;case`drag`:case`dragenter`:case`dragexit`:case`dragleave`:case`dragover`:case`mousemove`:case`mouseout`:case`mouseover`:case`pointermove`:case`pointerout`:case`pointerover`:case`scroll`:case`touchmove`:case`wheel`:case`mouseenter`:case`mouseleave`:case`pointerenter`:case`pointerleave`:return 8;case`message`:switch(Fe()){case Ie:return 2;case Le:return 8;case Re:case ze:return 32;case Be:return 268435456;default:return 32}default:return 32}}var hp=!1,gp=null,_p=null,vp=null,yp=new Map,bp=new Map,xp=[],Sp=`mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset`.split(` `);function Cp(e,t){switch(e){case`focusin`:case`focusout`:gp=null;break;case`dragenter`:case`dragleave`:_p=null;break;case`mouseover`:case`mouseout`:vp=null;break;case`pointerover`:case`pointerout`:yp.delete(t.pointerId);break;case`gotpointercapture`:case`lostpointercapture`:bp.delete(t.pointerId)}}function wp(e,t,n,r,i,a){return e===null||e.nativeEvent!==a?(e={blockedOn:t,domEventName:n,eventSystemFlags:r,nativeEvent:a,targetContainers:[i]},t!==null&&(t=wt(t),t!==null&&ap(t)),e):(e.eventSystemFlags|=r,t=e.targetContainers,i!==null&&t.indexOf(i)===-1&&t.push(i),e)}function Tp(e,t,n,r,i){switch(t){case`focusin`:return gp=wp(gp,e,t,n,r,i),!0;case`dragenter`:return _p=wp(_p,e,t,n,r,i),!0;case`mouseover`:return vp=wp(vp,e,t,n,r,i),!0;case`pointerover`:var a=i.pointerId;return yp.set(a,wp(yp.get(a)||null,e,t,n,r,i)),!0;case`gotpointercapture`:return a=i.pointerId,bp.set(a,wp(bp.get(a)||null,e,t,n,r,i)),!0}return!1}function Ep(e){var t=Ct(e.target);if(t!==null){var n=o(t);if(n!==null){if(t=n.tag,t===13){if(t=s(n),t!==null){e.blockedOn=t,ft(e.priority,function(){op(n)});return}}else if(t===31){if(t=c(n),t!==null){e.blockedOn=t,ft(e.priority,function(){op(n)});return}}else if(t===3&&n.stateNode.current.memoizedState.isDehydrated){e.blockedOn=n.tag===3?n.stateNode.containerInfo:null;return}}}e.blockedOn=null}function Dp(e){if(e.blockedOn!==null)return!1;for(var t=e.targetContainers;0<t.length;){var n=dp(e.nativeEvent);if(n===null){n=e.nativeEvent;var r=new n.constructor(n.type,n);ln=r,n.target.dispatchEvent(r),ln=null}else return t=wt(n),t!==null&&ap(t),e.blockedOn=n,!1;t.shift()}return!0}function Op(e,t,n){Dp(e)&&n.delete(t)}function kp(){hp=!1,gp!==null&&Dp(gp)&&(gp=null),_p!==null&&Dp(_p)&&(_p=null),vp!==null&&Dp(vp)&&(vp=null),yp.forEach(Op),bp.forEach(Op)}function Ap(e,n){e.blockedOn===n&&(e.blockedOn=null,hp||(hp=!0,t.unstable_scheduleCallback(t.unstable_NormalPriority,kp)))}var jp=null;function Mp(e){jp!==e&&(jp=e,t.unstable_scheduleCallback(t.unstable_NormalPriority,function(){jp===e&&(jp=null);for(var t=0;t<e.length;t+=3){var n=e[t],r=e[t+1],i=e[t+2];if(typeof r!=`function`){if(pp(r||n)===null)continue;break}var a=wt(n);a!==null&&(e.splice(t,3),t-=3,Os(a,{pending:!0,data:i,method:n.method,action:r},r,i))}}))}function Np(e){function t(t){return Ap(t,e)}gp!==null&&Ap(gp,e),_p!==null&&Ap(_p,e),vp!==null&&Ap(vp,e),yp.forEach(t),bp.forEach(t);for(var n=0;n<xp.length;n++){var r=xp[n];r.blockedOn===e&&(r.blockedOn=null)}for(;0<xp.length&&(n=xp[0],n.blockedOn===null);)Ep(n),n.blockedOn===null&&xp.shift();if(n=(e.ownerDocument||e).$$reactFormReplay,n!=null)for(r=0;r<n.length;r+=3){var i=n[r],a=n[r+1],o=i[ht]||null;if(typeof a==`function`)o||Mp(n);else if(o){var s=null;if(a&&a.hasAttribute(`formAction`)){if(i=a,o=a[ht]||null)s=o.formAction;else if(pp(i)!==null)continue}else s=o.action;typeof s==`function`?n[r+1]=s:(n.splice(r,3),r-=3),Mp(n)}}}function Pp(){function e(e){e.canIntercept&&e.info===`react-transition`&&e.intercept({handler:function(){return new Promise(function(e){return i=e})},focusReset:`manual`,scroll:`manual`})}function t(){i!==null&&(i(),i=null),r||setTimeout(n,20)}function n(){if(!r&&!navigation.transition){var e=navigation.currentEntry;e&&e.url!=null&&navigation.navigate(e.url,{state:e.getState(),info:`react-transition`,history:`replace`})}}if(typeof navigation==`object`){var r=!1,i=null;return navigation.addEventListener(`navigate`,e),navigation.addEventListener(`navigatesuccess`,t),navigation.addEventListener(`navigateerror`,t),setTimeout(n,100),function(){r=!0,navigation.removeEventListener(`navigate`,e),navigation.removeEventListener(`navigatesuccess`,t),navigation.removeEventListener(`navigateerror`,t),i!==null&&(i(),i=null)}}}function Fp(e){this._internalRoot=e}Ip.prototype.render=Fp.prototype.render=function(e){var t=this._internalRoot;if(t===null)throw Error(i(409));var n=t.current;np(n,pu(),e,t,null,null)},Ip.prototype.unmount=Fp.prototype.unmount=function(){var e=this._internalRoot;if(e!==null){this._internalRoot=null;var t=e.containerInfo;np(e.current,2,null,e,null,null),bu(),t[gt]=null}};function Ip(e){this._internalRoot=e}Ip.prototype.unstable_scheduleHydration=function(e){if(e){var t=dt();e={blockedOn:null,target:e,priority:t};for(var n=0;n<xp.length&&t!==0&&t<xp[n].priority;n++);xp.splice(n,0,e),n===0&&Ep(e)}};var Lp=n.version;if(Lp!==`19.2.7`)throw Error(i(527,Lp,`19.2.7`));E.findDOMNode=function(e){var t=e._reactInternals;if(t===void 0)throw typeof e.render==`function`?Error(i(188)):(e=Object.keys(e).join(`,`),Error(i(268,e)));return e=d(t),e=e===null?null:p(e),e=e===null?null:e.stateNode,e};var Rp={bundleType:0,version:`19.2.7`,rendererPackageName:`react-dom`,currentDispatcherRef:T,reconcilerVersion:`19.2.7`};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__<`u`){var zp=__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!zp.isDisabled&&zp.supportsFiber)try{Ue=zp.inject(Rp),A=zp}catch{}}e.createRoot=function(e,t){if(!a(e))throw Error(i(299));var n=!1,r=``,o=Zs,s=Qs,c=$s;return t!=null&&(!0===t.unstable_strictMode&&(n=!0),t.identifierPrefix!==void 0&&(r=t.identifierPrefix),t.onUncaughtError!==void 0&&(o=t.onUncaughtError),t.onCaughtError!==void 0&&(s=t.onCaughtError),t.onRecoverableError!==void 0&&(c=t.onRecoverableError)),t=ep(e,1,!1,null,null,n,r,null,o,s,c,Pp),e[gt]=t.current,Sd(e),new Fp(t)}})),g=o(((e,t)=>{function n(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>`u`||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!=`function`))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(n)}catch(e){console.error(e)}}n(),t.exports=h()})),_=c(u(),1),v=g(),y=(...e)=>e.filter((e,t,n)=>!!e&&e.trim()!==``&&n.indexOf(e)===t).join(` `).trim(),b=e=>e.replace(/([a-z0-9])([A-Z])/g,`$1-$2`).toLowerCase(),x=e=>e.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,t,n)=>n?n.toUpperCase():t.toLowerCase()),ee=e=>{let t=x(e);return t.charAt(0).toUpperCase()+t.slice(1)},S={xmlns:`http://www.w3.org/2000/svg`,width:24,height:24,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:2,strokeLinecap:`round`,strokeLinejoin:`round`},C=e=>{for(let t in e)if(t.startsWith(`aria-`)||t===`role`||t===`title`)return!0;return!1},te=(0,_.createContext)({}),ne=()=>(0,_.useContext)(te),re=(0,_.forwardRef)(({color:e,size:t,strokeWidth:n,absoluteStrokeWidth:r,className:i=``,children:a,iconNode:o,...s},c)=>{let{size:l=24,strokeWidth:u=2,absoluteStrokeWidth:d=!1,color:f=`currentColor`,className:p=``}=ne()??{},m=r??d?Number(n??u)*24/Number(t??l):n??u;return(0,_.createElement)(`svg`,{ref:c,...S,width:t??l??S.width,height:t??l??S.height,stroke:e??f,strokeWidth:m,className:y(`lucide`,p,i),...!a&&!C(s)&&{"aria-hidden":`true`},...s},[...o.map(([e,t])=>(0,_.createElement)(e,t)),...Array.isArray(a)?a:[a]])}),w=(e,t)=>{let n=(0,_.forwardRef)(({className:n,...r},i)=>(0,_.createElement)(re,{ref:i,iconNode:t,className:y(`lucide-${b(ee(e))}`,`lucide-${e}`,n),...r}));return n.displayName=ee(e),n},ie=w(`arrow-up-right`,[[`path`,{d:`M7 7h10v10`,key:`1tivn9`}],[`path`,{d:`M7 17 17 7`,key:`1vkiza`}]]),ae=w(`bell`,[[`path`,{d:`M10.268 21a2 2 0 0 0 3.464 0`,key:`vwvbt9`}],[`path`,{d:`M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326`,key:`11g9vi`}]]),oe=w(`building-2`,[[`path`,{d:`M10 12h4`,key:`a56b0p`}],[`path`,{d:`M10 8h4`,key:`1sr2af`}],[`path`,{d:`M14 21v-3a2 2 0 0 0-4 0v3`,key:`1rgiei`}],[`path`,{d:`M6 10H4a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-2`,key:`secmi2`}],[`path`,{d:`M6 21V5a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v16`,key:`16ra0t`}]]),se=w(`calendar`,[[`path`,{d:`M8 2v4`,key:`1cmpym`}],[`path`,{d:`M16 2v4`,key:`4m81vk`}],[`rect`,{width:`18`,height:`18`,x:`3`,y:`4`,rx:`2`,key:`1hopcy`}],[`path`,{d:`M3 10h18`,key:`8toen8`}]]),ce=w(`camera`,[[`path`,{d:`M13.997 4a2 2 0 0 1 1.76 1.05l.486.9A2 2 0 0 0 18.003 7H20a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h1.997a2 2 0 0 0 1.759-1.048l.489-.904A2 2 0 0 1 10.004 4z`,key:`18u6gg`}],[`circle`,{cx:`12`,cy:`13`,r:`3`,key:`1vg3eu`}]]),le=w(`chevron-left`,[[`path`,{d:`m15 18-6-6 6-6`,key:`1wnfg3`}]]),ue=w(`chevron-right`,[[`path`,{d:`m9 18 6-6-6-6`,key:`mthhwq`}]]),T=w(`circle-alert`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`line`,{x1:`12`,x2:`12`,y1:`8`,y2:`12`,key:`1pkeuh`}],[`line`,{x1:`12`,x2:`12.01`,y1:`16`,y2:`16`,key:`4dfq90`}]]),E=w(`circle-check-big`,[[`path`,{d:`M21.801 10A10 10 0 1 1 17 3.335`,key:`yps3ct`}],[`path`,{d:`m9 11 3 3L22 4`,key:`1pflzl`}]]),de=w(`clipboard-list`,[[`rect`,{width:`8`,height:`4`,x:`8`,y:`2`,rx:`1`,ry:`1`,key:`tgr4d6`}],[`path`,{d:`M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2`,key:`116196`}],[`path`,{d:`M12 11h4`,key:`1jrz19`}],[`path`,{d:`M12 16h4`,key:`n85exb`}],[`path`,{d:`M8 11h.01`,key:`1dfujw`}],[`path`,{d:`M8 16h.01`,key:`18s6g9`}]]),fe=w(`clock`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`M12 6v6l4 2`,key:`mmk7yg`}]]),pe=w(`cloud-upload`,[[`path`,{d:`M12 13v8`,key:`1l5pq0`}],[`path`,{d:`M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242`,key:`1pljnt`}],[`path`,{d:`m8 17 4-4 4 4`,key:`1quai1`}]]),me=w(`coffee`,[[`path`,{d:`M10 2v2`,key:`7u0qdc`}],[`path`,{d:`M14 2v2`,key:`6buw04`}],[`path`,{d:`M16 8a1 1 0 0 1 1 1v8a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4V9a1 1 0 0 1 1-1h14a4 4 0 1 1 0 8h-1`,key:`pwadti`}],[`path`,{d:`M6 2v2`,key:`colzsn`}]]),D=w(`database`,[[`ellipse`,{cx:`12`,cy:`5`,rx:`9`,ry:`3`,key:`msslwz`}],[`path`,{d:`M3 5V19A9 3 0 0 0 21 19V5`,key:`1wlel7`}],[`path`,{d:`M3 12A9 3 0 0 0 21 12`,key:`mv7ke4`}]]),O=w(`download`,[[`path`,{d:`M12 15V3`,key:`m9g1x1`}],[`path`,{d:`M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4`,key:`ih7n3h`}],[`path`,{d:`m7 10 5 5 5-5`,key:`brsn70`}]]),he=w(`eye`,[[`path`,{d:`M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0`,key:`1nclc0`}],[`circle`,{cx:`12`,cy:`12`,r:`3`,key:`1v7zrd`}]]),ge=w(`file-text`,[[`path`,{d:`M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z`,key:`1oefj6`}],[`path`,{d:`M14 2v5a1 1 0 0 0 1 1h5`,key:`wfsgrz`}],[`path`,{d:`M10 9H8`,key:`b1mrlr`}],[`path`,{d:`M16 13H8`,key:`t4e002`}],[`path`,{d:`M16 17H8`,key:`z1uh3a`}]]),_e=w(`funnel`,[[`path`,{d:`M10 20a1 1 0 0 0 .553.895l2 1A1 1 0 0 0 14 21v-7a2 2 0 0 1 .517-1.341L21.74 4.67A1 1 0 0 0 21 3H3a1 1 0 0 0-.742 1.67l7.225 7.989A2 2 0 0 1 10 14z`,key:`sc7q7i`}]]),ve=w(`layout-dashboard`,[[`rect`,{width:`7`,height:`9`,x:`3`,y:`3`,rx:`1`,key:`10lvy0`}],[`rect`,{width:`7`,height:`5`,x:`14`,y:`3`,rx:`1`,key:`16une8`}],[`rect`,{width:`7`,height:`9`,x:`14`,y:`12`,rx:`1`,key:`1hutg5`}],[`rect`,{width:`7`,height:`5`,x:`3`,y:`16`,rx:`1`,key:`ldoo1y`}]]),ye=w(`mail`,[[`path`,{d:`m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7`,key:`132q7q`}],[`rect`,{x:`2`,y:`4`,width:`20`,height:`16`,rx:`2`,key:`izxlao`}]]),be=w(`menu`,[[`path`,{d:`M4 5h16`,key:`1tepv9`}],[`path`,{d:`M4 12h16`,key:`1lakjw`}],[`path`,{d:`M4 19h16`,key:`1djgab`}]]),xe=w(`paperclip`,[[`path`,{d:`m16 6-8.414 8.586a2 2 0 0 0 2.829 2.829l8.414-8.586a4 4 0 1 0-5.657-5.657l-8.379 8.551a6 6 0 1 0 8.485 8.485l8.379-8.551`,key:`1miecu`}]]),Se=w(`refresh-cw`,[[`path`,{d:`M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8`,key:`v9h5vc`}],[`path`,{d:`M21 3v5h-5`,key:`1q7to0`}],[`path`,{d:`M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16`,key:`3uifl3`}],[`path`,{d:`M8 16H3v5`,key:`1cv678`}]]),Ce=w(`save`,[[`path`,{d:`M15.2 3a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z`,key:`1c8476`}],[`path`,{d:`M17 21v-7a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v7`,key:`1ydtos`}],[`path`,{d:`M7 3v4a1 1 0 0 0 1 1h7`,key:`t51u73`}]]),we=w(`search`,[[`path`,{d:`m21 21-4.34-4.34`,key:`14j7rj`}],[`circle`,{cx:`11`,cy:`11`,r:`8`,key:`4ej97u`}]]),Te=w(`settings`,[[`path`,{d:`M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915`,key:`1i5ecw`}],[`circle`,{cx:`12`,cy:`12`,r:`3`,key:`1v7zrd`}]]),Ee=w(`shield-alert`,[[`path`,{d:`M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z`,key:`oel41y`}],[`path`,{d:`M12 8v4`,key:`1got3b`}],[`path`,{d:`M12 16h.01`,key:`1drbdi`}]]),De=w(`shield-check`,[[`path`,{d:`M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z`,key:`oel41y`}],[`path`,{d:`m9 12 2 2 4-4`,key:`dzmm74`}]]),Oe=w(`shield`,[[`path`,{d:`M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z`,key:`oel41y`}]]),ke=w(`trash-2`,[[`path`,{d:`M10 11v6`,key:`nco0om`}],[`path`,{d:`M14 11v6`,key:`outv1u`}],[`path`,{d:`M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6`,key:`miytrc`}],[`path`,{d:`M3 6h18`,key:`d0wm0j`}],[`path`,{d:`M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2`,key:`e791ji`}]]),Ae=w(`upload`,[[`path`,{d:`M12 3v12`,key:`1x0j5s`}],[`path`,{d:`m17 8-5-5-5 5`,key:`7q97r8`}],[`path`,{d:`M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4`,key:`ih7n3h`}]]),je=w(`user`,[[`path`,{d:`M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2`,key:`975kel`}],[`circle`,{cx:`12`,cy:`7`,r:`4`,key:`17ys0d`}]]),Me=w(`users`,[[`path`,{d:`M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2`,key:`1yyitq`}],[`path`,{d:`M16 3.128a4 4 0 0 1 0 7.744`,key:`16gr8j`}],[`path`,{d:`M22 21v-2a4 4 0 0 0-3-3.87`,key:`kshegd`}],[`circle`,{cx:`9`,cy:`7`,r:`4`,key:`nufk8`}]]),Ne=w(`x`,[[`path`,{d:`M18 6 6 18`,key:`1bl5f8`}],[`path`,{d:`m6 6 12 12`,key:`d8bk6v`}]]),Pe=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),k=o(((e,t)=>{t.exports=Pe()}))();function Fe({currentView:e,onViewChange:t}){let[n,r]=(0,_.useState)(!1),i=[{id:`dashboard`,label:`Panel de Control`,icon:ve},{id:`intake`,label:`Subir Certificado`,icon:Ae},{id:`repository`,label:`Repositorio`,icon:D},{id:`calendar`,label:`Calendario`,icon:se},{id:`notifications`,label:`Registro de Alertas`,icon:ae},{id:`settings`,label:`Configuración`,icon:Te}],a=()=>{r(!n)},o=e=>{t(e),r(!1)};return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsxs)(`header`,{className:`mobile-header`,children:[(0,k.jsxs)(`div`,{className:`logo-container`,children:[(0,k.jsx)(me,{className:`logo-icon animate-pulse`}),(0,k.jsx)(`span`,{className:`logo-text`,style:{textTransform:`lowercase`},children:`historias y un café`})]}),(0,k.jsx)(`button`,{className:`mobile-toggle`,onClick:a,"aria-label":`Toggle Menu`,children:n?(0,k.jsx)(Ne,{size:24}):(0,k.jsx)(be,{size:24})})]}),(0,k.jsxs)(`aside`,{className:`sidebar ${n?`mobile-open`:``}`,children:[(0,k.jsxs)(`div`,{className:`sidebar-brand`,children:[(0,k.jsx)(me,{className:`logo-icon`}),(0,k.jsx)(`h1`,{className:`logo-text`,style:{textTransform:`lowercase`},children:`historias y un café`})]}),(0,k.jsx)(`nav`,{className:`sidebar-nav`,children:(0,k.jsx)(`ul`,{children:i.map(t=>{let n=t.icon,r=e===t.id;return(0,k.jsx)(`li`,{children:(0,k.jsxs)(`button`,{onClick:()=>o(t.id),className:`nav-link ${r?`active`:``}`,children:[(0,k.jsx)(n,{size:20,className:`nav-icon`}),(0,k.jsx)(`span`,{children:t.label}),r&&(0,k.jsx)(`div`,{className:`active-indicator`})]})},t.id)})})}),(0,k.jsx)(`div`,{className:`sidebar-footer`,children:(0,k.jsxs)(`div`,{className:`user-profile`,children:[(0,k.jsx)(`div`,{className:`avatar`,children:`AD`}),(0,k.jsxs)(`div`,{className:`user-info`,children:[(0,k.jsx)(`p`,{className:`user-name`,children:`Portal de Admin`}),(0,k.jsx)(`p`,{className:`user-role`,children:`Superusuario`})]})]})})]}),(0,k.jsx)(`style`,{children:`
      ...
      `})]})}var Ie=`HealthCertificatesDB`,Le=1;function Re(){return new Promise((e,t)=>{let n=indexedDB.open(Ie,Le);n.onerror=e=>{console.error(`Database error:`,e.target.error),t(e.target.error)},n.onsuccess=t=>{e(t.target.result)},n.onupgradeneeded=e=>{let t=e.target.result;if(!t.objectStoreNames.contains(`certificates`)){let e=t.createObjectStore(`certificates`,{keyPath:`id`});e.createIndex(`employeeName`,`employeeName`,{unique:!1}),e.createIndex(`expirationDate`,`expirationDate`,{unique:!1}),e.createIndex(`status`,`status`,{unique:!1})}if(!t.objectStoreNames.contains(`notifications`)){let e=t.createObjectStore(`notifications`,{keyPath:`id`,autoIncrement:!0});e.createIndex(`certificateId`,`certificateId`,{unique:!1}),e.createIndex(`sentAt`,`sentAt`,{unique:!1})}}})}async function ze(){let e=await Re();return new Promise((t,n)=>{let r=e.transaction(`certificates`,`readonly`).objectStore(`certificates`).getAll();r.onsuccess=()=>{let e=new Date().toISOString().split(`T`)[0],n=parseInt(localStorage.getItem(`warning_period`)||`14`,10);t(r.result.map(t=>{let r=Ve(t.expirationDate,e,n);return r!==t.status&&(t.status=r,Be(t.id,r)),t}))},r.onerror=()=>n(r.error)})}async function Be(e,t){try{let n=(await Re()).transaction(`certificates`,`readwrite`).objectStore(`certificates`),r=n.get(e);r.onsuccess=()=>{let e=r.result;e&&(e.status=t,n.put(e))}}catch(e){console.error(`Failed to sync status in DB:`,e)}}function Ve(e,t,n){if(!e)return`active`;let r=new Date(e),i=new Date(t);r.setHours(0,0,0,0),i.setHours(0,0,0,0);let a=r-i,o=Math.ceil(a/(1e3*60*60*24));return o<0?`expired`:o<=n?`expiring`:`active`}async function He(e){let t=await Re();return new Promise((n,r)=>{let i=t.transaction(`certificates`,`readonly`).objectStore(`certificates`).get(e);i.onsuccess=()=>n(i.result),i.onerror=()=>r(i.error)})}async function Ue(e){let t=await Re();return new Promise((n,r)=>{let i=t.transaction(`certificates`,`readwrite`).objectStore(`certificates`);e.id||=`cert_`+Math.random().toString(36).substr(2,9),e.uploadedAt||=new Date().toISOString();let a=new Date().toISOString().split(`T`)[0],o=parseInt(localStorage.getItem(`warning_period`)||`14`,10);e.status=Ve(e.expirationDate,a,o);let s=i.put(e);s.onsuccess=()=>n(e),s.onerror=()=>r(s.error)})}async function A(e){let t=await Re();return new Promise((n,r)=>{let i=t.transaction([`certificates`,`notifications`],`readwrite`);i.objectStore(`certificates`).delete(e);let a=i.objectStore(`notifications`).index(`certificateId`).openCursor(IDBKeyRange.only(e));a.onsuccess=e=>{let t=e.target.result;t&&(t.delete(),t.continue())},i.oncomplete=()=>n(!0),i.onerror=()=>r(i.error)})}async function We(e){let t=await Re();return new Promise((n,r)=>{let i=t.transaction(`notifications`,`readwrite`).objectStore(`notifications`).add(e);i.onsuccess=()=>n(i.result),i.onerror=()=>r(i.error)})}async function Ge(){let e=await Re();return new Promise((t,n)=>{let r=e.transaction(`notifications`,`readonly`).objectStore(`notifications`).getAll();r.onsuccess=()=>t(r.result.sort((e,t)=>new Date(t.sentAt)-new Date(e.sentAt))),r.onerror=()=>n(r.error)})}function Ke(e){return e?e.replace(/-/g,``):``}function qe(e){let{employeeName:t,expirationDate:n,id:r}=e;if(!n)return;let i=new Date(n),a=Ke(n),o=new Date(i);o.setDate(o.getDate()+1);let s=Ke(o.toISOString().split(`T`)[0]),c=new Date(i);c.setDate(c.getDate()-14);let l=c.toISOString().split(`T`)[0],u=Ke(l),d=new Date(c);d.setDate(d.getDate()+1);let f=Ke(d.toISOString().split(`T`)[0]),p=new Date().toISOString().replace(/[-:]/g,``).split(`.`)[0]+`Z`,m=[`BEGIN:VCALENDAR`,`VERSION:2.0`,`PRODID:-//HealthCert//CertificateMonitor//EN`,`CALSCALE:GREGORIAN`,`METHOD:PUBLISH`,`BEGIN:VEVENT`,`UID:exp_${r}@healthcert.system`,`DTSTAMP:${p}`,`DTSTART;VALUE=DATE:${a}`,`DTEND;VALUE=DATE:${s}`,`SUMMARY:🛡️ HEALTH CERT EXPIRED: ${t}`,`DESCRIPTION:Health certificate for ${t} has expired today. Renewal is required immediately. Document ID: ${r}`,`STATUS:CONFIRMED`,`TRANSP:TRANSPARENT`,`END:VEVENT`,`BEGIN:VEVENT`,`UID:warn_${r}@healthcert.system`,`DTSTAMP:${p}`,`DTSTART;VALUE=DATE:${u}`,`DTEND;VALUE=DATE:${f}`,`SUMMARY:⚠️ Renewal Due (2 Weeks): ${t}`,`DESCRIPTION:Reminder: Health certificate for ${t} will expire in 2 weeks on ${n}. Please arrange for a renewal. Document ID: ${r}`,`STATUS:CONFIRMED`,`TRANSP:TRANSPARENT`,`END:VEVENT`,`END:VCALENDAR`].join(`\r
`),h=new Blob([m],{type:`text/calendar;charset=utf-8`}),g=URL.createObjectURL(h),_=document.createElement(`a`);_.href=g,_.setAttribute(`download`,`${t.replace(/\s+/g,`_`)}_Health_Cert_Reminder.ics`),document.body.appendChild(_),_.click(),document.body.removeChild(_),URL.revokeObjectURL(g)}function Je({refreshTrigger:e,onViewChange:t}){let[n,r]=(0,_.useState)({total:0,active:0,expiring:0,expired:0,complianceScore:100}),[i,a]=(0,_.useState)([]),[o,s]=(0,_.useState)([]),[c,l]=(0,_.useState)(null),[u,d]=(0,_.useState)(``),[f,p]=(0,_.useState)(!0),m=(0,_.useRef)(null);(0,_.useEffect)(()=>{h()},[e]);let h=async()=>{p(!0);try{let e=await ze();s(await Ge());let t=e.length,n=0,i=0,o=0,c=[];e.forEach(e=>{e.status===`active`?n++:e.status===`expiring`?(i++,c.push(e)):e.status===`expired`&&(o++,c.push(e))}),c.sort((e,t)=>e.status===`expired`&&t.status!==`expired`?-1:e.status!==`expired`&&t.status===`expired`?1:new Date(e.expirationDate)-new Date(t.expirationDate));let l=t>0?Math.round((n+i)/t*100):100;r({total:t,active:n,expiring:i,expired:o,complianceScore:l}),a(c.slice(0,5))}catch(e){console.error(`Failed to load dashboard data:`,e)}finally{p(!1)}},g=e=>{l(e),e.imageBlob?d(URL.createObjectURL(e.imageBlob)):d(``),m.current&&m.current.showModal()},v=()=>{m.current&&m.current.close(),l(null),u&&(URL.revokeObjectURL(u),d(``))},y=async e=>{if(window.confirm(`¿Está seguro de que desea eliminar este certificado y todos sus registros de cumplimiento?`))try{await A(e),v(),h()}catch(e){console.error(e)}},b=2*Math.PI*50,x=b-n.complianceScore/100*b;return(0,k.jsxs)(`div`,{className:`dashboard-container animate-fade-in`,children:[(0,k.jsxs)(`div`,{className:`view-header`,children:[(0,k.jsx)(`h2`,{className:`view-title`,children:`Panel de Control de Cumplimiento`}),(0,k.jsx)(`p`,{className:`view-subtitle`,children:`Monitoree certificados de salud, alertas de vencimiento y notificaciones automáticamente.`})]}),f?(0,k.jsxs)(`div`,{className:`loading-state-dash`,children:[(0,k.jsx)(`div`,{className:`spinner`}),(0,k.jsx)(`p`,{children:`Analizando base de datos de cumplimiento...`})]}):(0,k.jsxs)(k.Fragment,{children:[(0,k.jsxs)(`div`,{className:`stats-row`,children:[(0,k.jsxs)(`div`,{className:`glass-card stat-card border-glow-cyan`,children:[(0,k.jsx)(`div`,{className:`stat-icon-wrapper icon-bg-cyan`,children:(0,k.jsx)(Me,{size:24})}),(0,k.jsxs)(`div`,{className:`stat-content`,children:[(0,k.jsx)(`p`,{className:`stat-label`,children:`Total Empleados en Seguimiento`}),(0,k.jsx)(`h3`,{className:`stat-value`,children:n.total})]})]}),(0,k.jsxs)(`div`,{className:`glass-card stat-card border-glow-green`,children:[(0,k.jsx)(`div`,{className:`stat-icon-wrapper icon-bg-green`,children:(0,k.jsx)(De,{size:24})}),(0,k.jsxs)(`div`,{className:`stat-content`,children:[(0,k.jsx)(`p`,{className:`stat-label`,children:`Cumplimiento Activo`}),(0,k.jsx)(`h3`,{className:`stat-value text-green`,children:n.active})]})]}),(0,k.jsxs)(`div`,{className:`glass-card stat-card border-glow-warning`,children:[(0,k.jsx)(`div`,{className:`stat-icon-wrapper icon-bg-warning`,children:(0,k.jsx)(fe,{size:24})}),(0,k.jsxs)(`div`,{className:`stat-content`,children:[(0,k.jsx)(`p`,{className:`stat-label`,children:`Vence Pronto (14d)`}),(0,k.jsx)(`h3`,{className:`stat-value text-warning`,children:n.expiring})]})]}),(0,k.jsxs)(`div`,{className:`glass-card stat-card border-glow-danger`,children:[(0,k.jsx)(`div`,{className:`stat-icon-wrapper icon-bg-danger`,children:(0,k.jsx)(Ee,{size:24})}),(0,k.jsxs)(`div`,{className:`stat-content`,children:[(0,k.jsx)(`p`,{className:`stat-label`,children:`Vencido (Acción Requerida)`}),(0,k.jsx)(`h3`,{className:`stat-value text-danger`,children:n.expired})]})]})]}),(0,k.jsxs)(`div`,{className:`analytics-grid`,children:[(0,k.jsxs)(`div`,{className:`glass-card compliance-panel`,children:[(0,k.jsx)(`h3`,{children:`Puntuación de Cumplimiento`}),(0,k.jsxs)(`div`,{className:`gauge-wrapper`,children:[(0,k.jsxs)(`svg`,{className:`radial-gauge`,viewBox:`0 0 120 120`,children:[(0,k.jsx)(`circle`,{className:`gauge-bg`,cx:`60`,cy:`60`,r:50,strokeWidth:8}),(0,k.jsx)(`circle`,{className:`gauge-progress ${n.complianceScore===100?`gauge-perfect`:n.complianceScore>=80?`gauge-good`:`gauge-poor`}`,cx:`60`,cy:`60`,r:50,strokeWidth:8,strokeDasharray:b,strokeDashoffset:x,transform:`rotate(-90 60 60)`})]}),(0,k.jsxs)(`div`,{className:`gauge-text`,children:[(0,k.jsxs)(`span`,{className:`gauge-percentage`,children:[n.complianceScore,`%`]}),(0,k.jsx)(`span`,{className:`gauge-label`,children:`Seguro`})]})]}),(0,k.jsx)(`div`,{className:`compliance-verdict`,children:n.complianceScore===100?(0,k.jsxs)(`p`,{className:`text-green flex items-center justify-center gap-1`,children:[(0,k.jsx)(Oe,{size:16}),` 100% en Cumplimiento. Sin acción inmediata.`]}):n.expired>0?(0,k.jsxs)(`p`,{className:`text-danger flex items-center justify-center gap-1`,children:[(0,k.jsx)(Ee,{size:16}),` Atención: Se detectaron `,n.expired,` certificado`,n.expired>1?`s`:``,` vencido`,n.expired>1?`s`:``,`.`]}):(0,k.jsxs)(`p`,{className:`text-warning flex items-center justify-center gap-1`,children:[(0,k.jsx)(fe,{size:16}),` Información: `,n.expiring,` renovación`,n.expiring>1?`es`:``,` aproximándose a la fecha límite.`]})})]}),(0,k.jsxs)(`div`,{className:`glass-card action-panel`,children:[(0,k.jsxs)(`div`,{className:`panel-header`,children:[(0,k.jsx)(`h3`,{children:`Cola de Renovación Urgente`}),(0,k.jsxs)(`button`,{onClick:()=>t(`repository`),className:`view-all-link`,children:[`Ver Repositorio `,(0,k.jsx)(ie,{size:16})]})]}),i.length===0?(0,k.jsxs)(`div`,{className:`compliant-shield-wrapper animate-fade-in`,children:[(0,k.jsx)(De,{size:50,className:`shield-sparkle`}),(0,k.jsx)(`h4`,{children:`Plantilla en Cumplimiento`}),(0,k.jsx)(`p`,{children:`Todos los empleados activos cuentan con registros de salud vigentes.`})]}):(0,k.jsx)(`div`,{className:`urgent-list`,children:i.map(e=>(0,k.jsxs)(`div`,{className:`urgent-item border-left-${e.status}`,onClick:()=>g(e),children:[(0,k.jsxs)(`div`,{className:`urgent-item-info`,children:[(0,k.jsx)(`h4`,{className:`urgent-name`,children:e.employeeName}),(0,k.jsxs)(`p`,{className:`urgent-date`,children:[`Vence: `,(0,k.jsx)(`strong`,{children:e.expirationDate})]})]}),(0,k.jsx)(`div`,{className:`urgent-item-action`,children:(0,k.jsx)(`span`,{className:`badge badge-${e.status}`,children:e.status===`expired`?`Vencido`:`Advertencia`})})]},e.id))})]})]}),(0,k.jsxs)(`div`,{className:`dashboard-footer-grid`,children:[(0,k.jsxs)(`div`,{className:`glass-card footer-subpanel`,children:[(0,k.jsx)(`h3`,{children:`Acciones de Cumplimiento Automáticas`}),(0,k.jsx)(`p`,{className:`footer-subpanel-desc`,children:`El sistema programa alertas de vencimiento y construye recordatorios de calendario automáticamente sin configuración manual.`}),(0,k.jsxs)(`div`,{className:`action-buttons-group`,children:[(0,k.jsx)(`button`,{className:`btn btn-primary`,onClick:()=>t(`intake`),children:`Subir Nuevo Certificado`}),(0,k.jsx)(`button`,{className:`btn btn-secondary`,onClick:()=>t(`calendar`),children:`Abrir Calendario de Cumplimiento`})]})]}),(0,k.jsxs)(`div`,{className:`glass-card footer-subpanel`,children:[(0,k.jsxs)(`div`,{className:`panel-header`,children:[(0,k.jsx)(`h3`,{children:`Alertas Recientes Activadas`}),(0,k.jsxs)(`button`,{onClick:()=>t(`notifications`),className:`view-all-link`,children:[`Ver Registro de Auditoría `,(0,k.jsx)(ie,{size:16})]})]}),o.length===0?(0,k.jsx)(`p`,{className:`no-logs-dash`,children:`Aún no se han enviado notificaciones automáticas.`}):(0,k.jsx)(`div`,{className:`recent-logs-list`,children:o.slice(0,3).map(e=>(0,k.jsxs)(`div`,{className:`recent-log-row`,children:[(0,k.jsxs)(`div`,{className:`recent-log-title`,children:[(0,k.jsx)(ae,{size:12,className:`recent-log-bell`}),(0,k.jsx)(`span`,{children:(0,k.jsx)(`strong`,{children:e.employeeName})})]}),(0,k.jsx)(`span`,{className:`recent-log-type`,children:e.type===`warning-14day`?`Aviso de 2 semanas`:`Alerta de Vencimiento`}),(0,k.jsx)(`span`,{className:`recent-log-date`,children:new Date(e.sentAt).toLocaleDateString()})]},e.id))})]})]})]}),(0,k.jsx)(`dialog`,{ref:m,className:`cert-dialog-modal glass-card`,onClose:v,children:c&&(0,k.jsxs)(`div`,{className:`modal-content-wrapper`,children:[(0,k.jsxs)(`div`,{className:`modal-header`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h2`,{children:c.employeeName}),(0,k.jsxs)(`p`,{className:`modal-subtitle`,children:[`ID de Certificado: `,c.id]})]}),(0,k.jsx)(`button`,{className:`close-modal-btn`,onClick:v,"aria-label":`Cerrar Modal`,children:(0,k.jsx)(Ne,{size:24})})]}),(0,k.jsxs)(`div`,{className:`modal-body-grid`,children:[(0,k.jsx)(`div`,{className:`modal-document-viewer`,children:c.imageType===`application/pdf`?(0,k.jsxs)(`div`,{className:`pdf-viewer-placeholder`,children:[(0,k.jsx)(ge,{size:100,className:`pdf-modal-icon`}),(0,k.jsx)(`h4`,{children:`Documento PDF`}),(0,k.jsx)(`p`,{children:c.imageName}),(0,k.jsx)(`a`,{href:u,download:c.imageName,className:`btn btn-secondary mt-4`,children:`Descargar PDF`})]}):u?(0,k.jsx)(`img`,{src:u,alt:`Escaneo de Certificado`,className:`modal-image-display`}):(0,k.jsx)(`div`,{className:`no-image-placeholder`,children:`No se adjuntó ningún archivo de documento.`})}),(0,k.jsx)(`div`,{className:`modal-metadata-section`,children:(0,k.jsxs)(`div`,{className:`meta-card`,children:[(0,k.jsx)(`h3`,{children:`Resumen de Cumplimiento`}),(0,k.jsxs)(`div`,{className:`meta-detail-row`,children:[(0,k.jsx)(`span`,{className:`meta-label`,children:`Estado`}),(0,k.jsx)(`span`,{className:`badge badge-${c.status}`,children:c.status===`active`?`Activo`:c.status===`expiring`?`Vence Pronto`:`Vencido`})]}),(0,k.jsxs)(`div`,{className:`meta-detail-row`,children:[(0,k.jsx)(`span`,{className:`meta-label`,children:`Fecha de Emisión`}),(0,k.jsx)(`span`,{className:`meta-value`,children:c.issueDate})]}),(0,k.jsxs)(`div`,{className:`meta-detail-row`,children:[(0,k.jsx)(`span`,{className:`meta-label`,children:`Fecha de Vencimiento`}),(0,k.jsx)(`span`,{className:`meta-value`,children:c.expirationDate?c.expirationDate:`Indefinido (Sin Vencimiento)`})]}),(0,k.jsxs)(`div`,{className:`meta-actions`,children:[c.expirationDate&&(0,k.jsxs)(`button`,{className:`btn btn-primary`,onClick:()=>qe(c),children:[(0,k.jsx)(O,{size:16}),` Exportar Recordatorio (.ics)`]}),(0,k.jsxs)(`button`,{className:`btn btn-danger`,onClick:()=>y(c.id),children:[(0,k.jsx)(ke,{size:16}),` Eliminar Registro`]})]})]})})]})]})}),(0,k.jsx)(`style`,{children:`
        .dashboard-container {
          max-width: 1200px;
          margin: 0 auto;
          width: 100%;
      ...
      `})]})}function Ye({onUploadSuccess:e}){let[t,n]=(0,_.useState)(``),[r,i]=(0,_.useState)(``),[a,o]=(0,_.useState)(``),[s,c]=(0,_.useState)(`1year`),[l,u]=(0,_.useState)(``),[d,f]=(0,_.useState)(``),[p,m]=(0,_.useState)(null),[h,g]=(0,_.useState)(``),[v,y]=(0,_.useState)(!1),[b,x]=(0,_.useState)(``),[ee,S]=(0,_.useState)(!1),[C,te]=(0,_.useState)(``),[ne,re]=(0,_.useState)(!1),w=(0,_.useRef)(null),ie=(0,_.useRef)(null),ae=(0,_.useRef)(null);(0,_.useEffect)(()=>{if(!a||s===`none`||s===`custom`){s===`none`&&u(``);return}let e=new Date(a);isNaN(e.getTime())||(s===`1year`&&e.setFullYear(e.getFullYear()+1),s===`2years`&&e.setFullYear(e.getFullYear()+2),u(e.toISOString().split(`T`)[0]))},[a,s]);let le=async()=>{x(``),y(!0);try{let e=await navigator.mediaDevices.getUserMedia({video:{facingMode:`environment`}});ae.current=e,ie.current&&(ie.current.srcObject=e)}catch{x(`No se pudo acceder a la cámara. Por favor, suba un archivo.`),y(!1)}},ue=()=>{ae.current?.getTracks().forEach(e=>e.stop()),ae.current=null,y(!1)};(0,_.useEffect)(()=>()=>ue(),[]);let fe=()=>{if(!ie.current)return;let e=ie.current,t=document.createElement(`canvas`);t.width=e.videoWidth,t.height=e.videoHeight,t.getContext(`2d`).drawImage(e,0,0),t.toBlob(e=>{me(new File([e],`photo_${Date.now()}.png`,{type:`image/png`})),ue()},`image/png`)},me=e=>{m(e),g(URL.createObjectURL(e))},D=e=>{e.target.files?.[0]&&me(e.target.files[0])},O=()=>{m(null),g(``),w.current&&(w.current.value=``)},he=e=>{e.preventDefault(),re(!0)},_e=()=>re(!1),ve=e=>{e.preventDefault(),re(!1),e.dataTransfer.files?.[0]&&me(e.dataTransfer.files[0])},ye=async n=>{if(n.preventDefault(),x(``),!t.trim())return x(`El nombre del empleado es obligatorio.`);if(!a)return x(`La fecha de emisión es obligatoria.`);if(s===`custom`&&!l)return x(`Por favor, ingrese la fecha de vencimiento.`);try{await Ue({employeeName:t.trim(),department:r.trim(),issueDate:a,expirationDate:s===`none`?``:l,businessRule:s,notes:d.trim(),imageBlob:p||null,imageName:p?.name||null,imageType:p?.type||null,uploadedAt:new Date().toISOString()}),te(t.trim()),S(!0),e&&e()}catch(e){x(`No se pudo guardar el registro: `+e.message)}},be=()=>{n(``),i(``),o(``),c(`1year`),u(``),f(``),m(null),g(``),S(!1),te(``),x(``)},Ce=!l||s===`none`?null:new Date(l+`T00:00:00`).toLocaleDateString(`es-ES`,{year:`numeric`,month:`long`,day:`numeric`});return ee?(0,k.jsx)(`div`,{className:`intake-container animate-fade-in`,children:(0,k.jsxs)(`div`,{className:`glass-card success-card`,children:[(0,k.jsx)(E,{className:`success-icon`,size:64}),(0,k.jsx)(`h3`,{children:`¡Registro Guardado!`}),(0,k.jsxs)(`p`,{children:[`El certificado de salud para `,(0,k.jsx)(`strong`,{children:C}),` ha sido agregado al sistema. El monitoreo de vencimiento ya está activo.`]}),(0,k.jsx)(`div`,{className:`success-actions`,children:(0,k.jsx)(`button`,{className:`btn btn-primary`,onClick:be,children:`Agregar Otro Certificado`})})]})}):(0,k.jsxs)(`div`,{className:`intake-container animate-fade-in`,children:[(0,k.jsxs)(`div`,{className:`view-header`,children:[(0,k.jsx)(`h2`,{className:`view-title`,children:`Nuevo Certificado de Salud`}),(0,k.jsx)(`p`,{className:`view-subtitle`,children:`Ingrese los detalles del certificado del empleado. Todo el seguimiento y las alertas de vencimiento se gestionan automáticamente.`})]}),b&&(0,k.jsxs)(`div`,{className:`alert-banner alert-error flex items-center gap-2`,children:[(0,k.jsx)(T,{size:18}),(0,k.jsx)(`span`,{children:b})]}),(0,k.jsxs)(`div`,{className:`intake-grid`,children:[(0,k.jsxs)(`div`,{className:`glass-card form-panel`,children:[(0,k.jsxs)(`div`,{className:`panel-heading`,children:[(0,k.jsx)(de,{size:18}),(0,k.jsx)(`span`,{children:`Detalles del Certificado`})]}),(0,k.jsxs)(`form`,{id:`intake-form`,onSubmit:ye,className:`details-form`,noValidate:!0,children:[(0,k.jsxs)(`div`,{className:`form-group`,children:[(0,k.jsxs)(`label`,{className:`form-label`,htmlFor:`employee-name`,children:[`Nombre del Empleado `,(0,k.jsx)(`span`,{className:`required-star`,children:`*`})]}),(0,k.jsxs)(`div`,{className:`input-with-icon`,children:[(0,k.jsx)(je,{size:16,className:`input-icon`}),(0,k.jsx)(`input`,{type:`text`,id:`employee-name`,className:`form-input`,value:t,onChange:e=>n(e.target.value),placeholder:`Ej. Juan del Pueblo`,autoComplete:`off`,required:!0})]})]}),(0,k.jsxs)(`div`,{className:`form-group`,children:[(0,k.jsxs)(`label`,{className:`form-label`,htmlFor:`department`,children:[`Departamento `,(0,k.jsx)(`span`,{className:`optional-tag`,children:`opcional`})]}),(0,k.jsxs)(`div`,{className:`input-with-icon`,children:[(0,k.jsx)(oe,{size:16,className:`input-icon`}),(0,k.jsx)(`input`,{type:`text`,id:`department`,className:`form-input`,value:r,onChange:e=>i(e.target.value),placeholder:`Ej. Cocina, Almacén, Oficina…`,autoComplete:`off`})]})]}),(0,k.jsxs)(`div`,{className:`form-group`,children:[(0,k.jsxs)(`label`,{className:`form-label`,htmlFor:`issue-date`,children:[`Fecha de Emisión `,(0,k.jsx)(`span`,{className:`required-star`,children:`*`})]}),(0,k.jsxs)(`div`,{className:`input-with-icon`,children:[(0,k.jsx)(se,{size:16,className:`input-icon`}),(0,k.jsx)(`input`,{type:`date`,id:`issue-date`,className:`form-input`,value:a,onChange:e=>o(e.target.value),required:!0})]})]}),(0,k.jsxs)(`div`,{className:`form-group`,children:[(0,k.jsxs)(`label`,{className:`form-label`,htmlFor:`business-rule`,children:[`Periodo de Validez `,(0,k.jsx)(`span`,{className:`required-star`,children:`*`})]}),(0,k.jsxs)(`select`,{id:`business-rule`,className:`form-input`,value:s,onChange:e=>c(e.target.value),children:[(0,k.jsx)(`option`,{value:`1year`,children:`1 Año desde la Fecha de Emisión`}),(0,k.jsx)(`option`,{value:`2years`,children:`2 Años desde la Fecha de Emisión`}),(0,k.jsx)(`option`,{value:`custom`,children:`Ingresar fecha de vencimiento exacta`}),(0,k.jsx)(`option`,{value:`none`,children:`Sin vencimiento`})]})]}),s===`custom`&&(0,k.jsxs)(`div`,{className:`form-group animate-fade-in`,children:[(0,k.jsxs)(`label`,{className:`form-label`,htmlFor:`custom-expiration`,children:[`Fecha de Vencimiento `,(0,k.jsx)(`span`,{className:`required-star`,children:`*`})]}),(0,k.jsxs)(`div`,{className:`input-with-icon`,children:[(0,k.jsx)(se,{size:16,className:`input-icon`}),(0,k.jsx)(`input`,{type:`date`,id:`custom-expiration`,className:`form-input`,value:l,onChange:e=>u(e.target.value),required:!0})]})]}),Ce&&s!==`custom`&&(0,k.jsxs)(`div`,{className:`expiry-preview`,children:[(0,k.jsx)(se,{size:14}),(0,k.jsxs)(`span`,{children:[`El certificado vence el `,(0,k.jsx)(`strong`,{children:Ce})]})]}),(0,k.jsxs)(`div`,{className:`form-group`,children:[(0,k.jsxs)(`label`,{className:`form-label`,htmlFor:`notes`,children:[`Notas `,(0,k.jsx)(`span`,{className:`optional-tag`,children:`opcional`})]}),(0,k.jsx)(`textarea`,{id:`notes`,className:`form-input form-textarea`,value:d,onChange:e=>f(e.target.value),placeholder:`Notas adicionales (médico emisor, centro de salud, etc.)`,rows:3})]}),(0,k.jsxs)(`div`,{className:`form-actions-row`,children:[(0,k.jsx)(`button`,{type:`button`,className:`btn btn-secondary`,onClick:be,children:`Limpiar`}),(0,k.jsx)(`button`,{type:`submit`,className:`btn btn-primary`,children:`Guardar y Empezar Seguimiento`})]})]})]}),(0,k.jsxs)(`div`,{className:`glass-card attach-panel`,children:[(0,k.jsxs)(`div`,{className:`panel-heading`,children:[(0,k.jsx)(xe,{size:18}),(0,k.jsxs)(`span`,{children:[`Adjuntar Documento `,(0,k.jsx)(`span`,{className:`optional-tag`,children:`opcional`})]})]}),(0,k.jsx)(`p`,{className:`attach-hint`,children:`Adjunte una foto o escaneo para sus registros. Esto se almacena localmente y no es obligatorio para guardar el certificado.`}),v&&(0,k.jsxs)(`div`,{className:`camera-view-container`,children:[(0,k.jsx)(`video`,{ref:ie,autoPlay:!0,playsInline:!0,className:`video-stream`}),(0,k.jsx)(`div`,{className:`camera-overlay`}),(0,k.jsxs)(`div`,{className:`camera-controls`,children:[(0,k.jsx)(`button`,{className:`btn btn-danger`,onClick:ue,children:`Cancelar`}),(0,k.jsx)(`button`,{className:`capture-btn`,onClick:fe,"aria-label":`Tomar Foto`})]})]}),!v&&!h&&(0,k.jsxs)(`div`,{className:`dropzone ${ne?`dropzone-active`:``}`,onDragOver:he,onDragLeave:_e,onDrop:ve,onClick:()=>w.current?.click(),children:[(0,k.jsx)(pe,{size:40,className:`upload-icon`}),(0,k.jsx)(`p`,{className:`dropzone-title`,children:`Arrastre y suelte o haga clic para buscar`}),(0,k.jsx)(`p`,{className:`dropzone-sub`,children:`PNG, JPG, PDF — hasta 10 MB`}),(0,k.jsx)(`div`,{className:`divider`,children:(0,k.jsx)(`span`,{children:`O`})}),(0,k.jsxs)(`button`,{type:`button`,className:`btn btn-secondary`,onClick:e=>{e.stopPropagation(),le()},children:[(0,k.jsx)(ce,{size:15}),` Usar Cámara`]})]}),!v&&h&&(0,k.jsxs)(`div`,{className:`preview-wrapper`,children:[p?.type===`application/pdf`?(0,k.jsxs)(`div`,{className:`pdf-placeholder`,children:[(0,k.jsx)(ge,{size:64,className:`pdf-icon`}),(0,k.jsx)(`p`,{className:`pdf-name`,children:p.name}),(0,k.jsx)(`span`,{className:`badge badge-active`,children:`PDF Listo`})]}):(0,k.jsx)(`img`,{src:h,alt:`Certificate preview`,className:`image-preview`}),(0,k.jsx)(`button`,{className:`remove-file-btn`,onClick:O,title:`Eliminar archivo`,children:(0,k.jsx)(Ne,{size:14})}),(0,k.jsxs)(`button`,{type:`button`,className:`btn btn-secondary replace-btn`,onClick:()=>w.current?.click(),children:[(0,k.jsx)(Se,{size:14}),` Reemplazar`]})]}),(0,k.jsx)(`input`,{type:`file`,ref:w,style:{display:`none`},accept:`image/*,application/pdf`,onChange:D})]})]}),(0,k.jsx)(`style`,{children:`
        .intake-container {
          max-width: 1100px;
          margin: 0 auto;
          width: 100%;
      ...
      `})]})}function Xe({refreshTrigger:e,onRecordDeleted:t}){let[n,r]=(0,_.useState)([]),[i,a]=(0,_.useState)([]),[o,s]=(0,_.useState)([]),[c,l]=(0,_.useState)(``),[u,d]=(0,_.useState)(`all`),[f,p]=(0,_.useState)(null),[m,h]=(0,_.useState)(``),[g,v]=(0,_.useState)(!0),y=(0,_.useRef)(null);(0,_.useEffect)(()=>{b()},[e]),(0,_.useEffect)(()=>{x()},[n,c,u]);let b=async()=>{v(!0);try{let e=await ze(),t=await Ge();r(e),s(t)}catch(e){console.error(`Failed to load certificates:`,e)}finally{v(!1)}},x=()=>{let e=[...n];if(c.trim()!==``){let t=c.toLowerCase();e=e.filter(e=>e.employeeName.toLowerCase().includes(t))}u!==`all`&&(e=e.filter(e=>e.status===u)),e.sort((e,t)=>e.expirationDate?t.expirationDate?new Date(e.expirationDate)-new Date(t.expirationDate):-1:1),a(e)},ee=e=>{p(e),e.imageBlob?h(URL.createObjectURL(e.imageBlob)):h(``),y.current&&y.current.showModal()},S=()=>{y.current&&y.current.close(),p(null),m&&(URL.revokeObjectURL(m),h(``))},C=async(e,n)=>{if(n&&n.stopPropagation(),window.confirm(`¿Está seguro de que desea eliminar este certificado y todos sus registros de cumplimiento?`))try{await A(e),f&&f.id===e&&S(),b(),t&&t()}catch(e){console.error(`Delete failed:`,e),alert(`Error al eliminar el certificado: `+e.message)}},te=e=>o.filter(t=>t.certificateId===e);return(0,k.jsxs)(`div`,{className:`repository-container animate-fade-in`,children:[(0,k.jsxs)(`div`,{className:`view-header`,children:[(0,k.jsx)(`h2`,{className:`view-title`,children:`Repositorio de Certificados`}),(0,k.jsx)(`p`,{className:`view-subtitle`,children:`Busque, verifique el cumplimiento, descargue recordatorios y vea los registros de todo el personal.`})]}),(0,k.jsxs)(`div`,{className:`glass-card control-bar`,children:[(0,k.jsxs)(`div`,{className:`search-box`,children:[(0,k.jsx)(we,{size:18,className:`search-icon`}),(0,k.jsx)(`input`,{type:`text`,className:`search-input`,placeholder:`Buscar por nombre del empleado...`,value:c,onChange:e=>l(e.target.value)})]}),(0,k.jsxs)(`div`,{className:`filter-box`,children:[(0,k.jsx)(_e,{size:18,className:`filter-icon`}),(0,k.jsxs)(`select`,{className:`filter-select`,value:u,onChange:e=>d(e.target.value),children:[(0,k.jsx)(`option`,{value:`all`,children:`Todos los Estados`}),(0,k.jsx)(`option`,{value:`active`,children:`Cumplimiento Activo`}),(0,k.jsx)(`option`,{value:`expiring`,children:`Vence Pronto (Advertencia)`}),(0,k.jsx)(`option`,{value:`expired`,children:`Vencido (Atención Urgente)`})]})]})]}),g?(0,k.jsxs)(`div`,{className:`loading-state-repo`,children:[(0,k.jsx)(`div`,{className:`spinner`}),(0,k.jsx)(`p`,{children:`Recuperando registros de la base de datos...`})]}):i.length===0?(0,k.jsxs)(`div`,{className:`glass-card empty-repo-state`,children:[(0,k.jsx)(ge,{size:64,className:`empty-icon`}),(0,k.jsx)(`h3`,{children:`No se Encontraron Registros`}),(0,k.jsx)(`p`,{children:`Intente ajustar los criterios de búsqueda, las opciones de filtro o suba un nuevo certificado para comenzar el seguimiento.`})]}):(0,k.jsx)(`div`,{className:`certs-grid`,children:i.map(e=>(0,k.jsxs)(`div`,{className:`glass-card cert-card cert-border-${e.status}`,onClick:()=>ee(e),children:[(0,k.jsxs)(`div`,{className:`cert-card-header`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h3`,{className:`cert-emp-name`,children:e.employeeName}),(0,k.jsxs)(`span`,{className:`cert-id-tag`,children:[`ID: `,e.id]})]}),(0,k.jsx)(`span`,{className:`badge badge-${e.status}`,children:e.status===`active`?`Activo`:e.status===`expiring`?`Vence Pronto`:`Vencido`})]}),(0,k.jsxs)(`div`,{className:`cert-card-body`,children:[(0,k.jsxs)(`div`,{className:`cert-info-row`,children:[(0,k.jsx)(se,{size:15,className:`row-icon`}),(0,k.jsxs)(`span`,{children:[`Fecha de Emisión: `,(0,k.jsx)(`strong`,{children:e.issueDate})]})]}),(0,k.jsxs)(`div`,{className:`cert-info-row`,children:[(0,k.jsx)(fe,{size:15,className:`row-icon`}),(0,k.jsxs)(`span`,{children:[`Vence:`,` `,(0,k.jsx)(`strong`,{children:e.expirationDate?e.expirationDate:`Indefinido`})]})]})]}),(0,k.jsxs)(`div`,{className:`cert-card-actions`,onClick:e=>e.stopPropagation(),children:[(0,k.jsx)(`button`,{className:`icon-btn`,onClick:()=>ee(e),title:`Ver Detalles del Documento`,children:(0,k.jsx)(he,{size:16})}),e.expirationDate&&(0,k.jsx)(`button`,{className:`icon-btn`,onClick:()=>qe(e),title:`Exportar Sincronización de Calendario (.ics)`,children:(0,k.jsx)(O,{size:16})}),(0,k.jsx)(`button`,{className:`icon-btn btn-danger-text`,onClick:t=>C(e.id,t),title:`Eliminar Certificado`,children:(0,k.jsx)(ke,{size:16})})]})]},e.id))}),(0,k.jsx)(`dialog`,{ref:y,className:`cert-dialog-modal glass-card`,onClose:S,children:f&&(0,k.jsxs)(`div`,{className:`modal-content-wrapper`,children:[(0,k.jsxs)(`div`,{className:`modal-header`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h2`,{children:f.employeeName}),(0,k.jsxs)(`p`,{className:`modal-subtitle`,children:[`ID de Certificado: `,f.id]})]}),(0,k.jsx)(`button`,{className:`close-modal-btn`,onClick:S,"aria-label":`Cerrar Modal`,children:(0,k.jsx)(Ne,{size:24})})]}),(0,k.jsxs)(`div`,{className:`modal-body-grid`,children:[(0,k.jsx)(`div`,{className:`modal-document-viewer`,children:f.imageType===`application/pdf`?(0,k.jsxs)(`div`,{className:`pdf-viewer-placeholder`,children:[(0,k.jsx)(ge,{size:100,className:`pdf-modal-icon`}),(0,k.jsx)(`h4`,{children:`Documento PDF`}),(0,k.jsx)(`p`,{children:f.imageName}),(0,k.jsx)(`a`,{href:m,download:f.imageName,className:`btn btn-secondary mt-4`,children:`Descargar PDF`})]}):m?(0,k.jsx)(`img`,{src:m,alt:`Escaneo del documento del certificado`,className:`modal-image-display`}):(0,k.jsx)(`div`,{className:`no-image-placeholder`,children:`No se adjuntó ningún archivo de documento.`})}),(0,k.jsxs)(`div`,{className:`modal-metadata-section`,children:[(0,k.jsxs)(`div`,{className:`meta-card`,children:[(0,k.jsx)(`h3`,{children:`Resumen de Cumplimiento`}),(0,k.jsxs)(`div`,{className:`meta-detail-row`,children:[(0,k.jsx)(`span`,{className:`meta-label`,children:`Estado`}),(0,k.jsx)(`span`,{className:`badge badge-${f.status}`,children:f.status===`active`?`Activo`:f.status===`expiring`?`Vence Pronto`:`Vencido`})]}),(0,k.jsxs)(`div`,{className:`meta-detail-row`,children:[(0,k.jsx)(`span`,{className:`meta-label`,children:`Fecha de Emisión`}),(0,k.jsx)(`span`,{className:`meta-value`,children:f.issueDate})]}),(0,k.jsxs)(`div`,{className:`meta-detail-row`,children:[(0,k.jsx)(`span`,{className:`meta-label`,children:`Fecha de Vencimiento`}),(0,k.jsx)(`span`,{className:`meta-value`,children:f.expirationDate?f.expirationDate:`Indefinido`})]}),(0,k.jsxs)(`div`,{className:`meta-detail-row`,children:[(0,k.jsx)(`span`,{className:`meta-label`,children:`Regla de Validez`}),(0,k.jsx)(`span`,{className:`meta-value`,children:f.businessRule===`1year`?`Expiración a 1 Año`:f.businessRule===`2years`?`Expiración a 2 Años`:f.businessRule===`none`?`Validez Indefinida`:`Fecha de Vencimiento Personalizada`})]}),(0,k.jsxs)(`div`,{className:`meta-detail-row`,children:[(0,k.jsx)(`span`,{className:`meta-label`,children:`Fecha de Registro`}),(0,k.jsx)(`span`,{className:`meta-value`,children:new Date(f.uploadedAt).toLocaleString()})]}),(0,k.jsxs)(`div`,{className:`meta-actions`,children:[f.expirationDate&&(0,k.jsxs)(`button`,{className:`btn btn-primary`,onClick:()=>qe(f),children:[(0,k.jsx)(O,{size:16}),` Exportar Recordatorio (.ics)`]}),(0,k.jsxs)(`button`,{className:`btn btn-danger`,onClick:()=>C(f.id),children:[(0,k.jsx)(ke,{size:16}),` Eliminar Registro`]})]})]}),(0,k.jsxs)(`div`,{className:`meta-card alert-history`,children:[(0,k.jsx)(`h3`,{children:`Auditoría de Alertas Automáticas`}),te(f.id).length===0?(0,k.jsx)(`p`,{className:`no-alerts-text`,children:`Aún no se han programado ni enviado alertas automáticas.`}):(0,k.jsx)(`ul`,{className:`alert-list-trail`,children:te(f.id).map(e=>(0,k.jsxs)(`li`,{className:`alert-trail-item`,children:[(0,k.jsxs)(`div`,{className:`alert-item-header`,children:[(0,k.jsxs)(`span`,{className:`alert-type`,children:[(0,k.jsx)(ye,{size:12,className:`alert-mail-icon`}),e.type===`warning-14day`?`Correo de Aviso (2 semanas)`:`Correo de Alerta de Vencimiento`]}),(0,k.jsx)(`span`,{className:`alert-timestamp`,children:new Date(e.sentAt).toLocaleDateString()})]}),(0,k.jsxs)(`p`,{className:`alert-details-desc`,children:[`Enviado auto. a: `,(0,k.jsx)(`strong`,{children:e.recipient}),`. Estado: `,(0,k.jsx)(`span`,{className:`green-text`,children:`Enviado`})]})]},e.id))})]})]})]})]})}),(0,k.jsx)(`style`,{children:`
      ...
      `})]})}function Ze({refreshTrigger:e,onRecordDeleted:t}){let[n,r]=(0,_.useState)(new Date),[i,a]=(0,_.useState)([]),[o,s]=(0,_.useState)([]),[c,l]=(0,_.useState)(null),[u,d]=(0,_.useState)(``),f=(0,_.useRef)(null);(0,_.useEffect)(()=>{p()},[e]);let p=async()=>{try{let e=await ze(),t=await Ge();a(e),s(t)}catch(e){console.error(`Failed to load certificates for calendar:`,e)}},m=e=>new Date(e.getFullYear(),e.getMonth()+1,0).getDate(),h=e=>new Date(e.getFullYear(),e.getMonth(),1).getDay(),g=()=>{r(new Date(n.getFullYear(),n.getMonth()+1,1))},v=()=>{r(new Date(n.getFullYear(),n.getMonth()-1,1))},y=()=>{r(new Date)},b=()=>{let e=m(n),t=h(n),r=[];for(let e=0;e<t;e++)r.push({day:null,dateStr:null});for(let t=1;t<=e;t++){let e=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}-${String(t).padStart(2,`0`)}`;r.push({day:t,dateStr:e})}return r},x=e=>{if(!e)return[];let t=[];return i.forEach(n=>{if(!n.expirationDate)return;n.expirationDate===e&&t.push({type:`expiration`,title:`☠️ Vencido: ${n.employeeName}`,cert:n});let r=new Date(n.expirationDate);r.setDate(r.getDate()-14),r.toISOString().split(`T`)[0]===e&&t.push({type:`warning`,title:`⚠️ Renovación: ${n.employeeName}`,cert:n})}),t},ee=e=>{l(e),e.imageBlob?d(URL.createObjectURL(e.imageBlob)):d(``),f.current&&f.current.showModal()},S=()=>{f.current&&f.current.close(),l(null),u&&(URL.revokeObjectURL(u),d(``))},C=async e=>{if(window.confirm(`¿Está seguro de que desea eliminar este certificado y todos sus registros de cumplimiento?`))try{await A(e),S(),p(),t&&t()}catch(e){console.error(e),alert(`Error al eliminar`)}};return(0,k.jsxs)(`div`,{className:`calendar-view-container animate-fade-in`,children:[(0,k.jsxs)(`div`,{className:`view-header flex-header`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h2`,{className:`view-title`,children:`Calendario de Cumplimiento`}),(0,k.jsx)(`p`,{className:`view-subtitle`,children:`Monitoree notificaciones programadas y plazos de vencimiento de certificados.`})]}),(0,k.jsxs)(`div`,{className:`calendar-controls-bar`,children:[(0,k.jsx)(`button`,{className:`btn btn-secondary py-1 px-3`,onClick:v,children:(0,k.jsx)(le,{size:16})}),(0,k.jsxs)(`span`,{className:`current-month-label`,children:[[`Enero`,`Febrero`,`Marzo`,`Abril`,`Mayo`,`Junio`,`Julio`,`Agosto`,`Septiembre`,`Octubre`,`Noviembre`,`Diciembre`][n.getMonth()],` `,n.getFullYear()]}),(0,k.jsx)(`button`,{className:`btn btn-secondary py-1 px-3`,onClick:g,children:(0,k.jsx)(ue,{size:16})}),(0,k.jsx)(`button`,{className:`btn btn-primary py-1 px-3`,onClick:y,children:`Hoy`})]})]}),(0,k.jsxs)(`div`,{className:`glass-card calendar-card`,children:[(0,k.jsx)(`div`,{className:`calendar-grid-header`,children:[`Dom`,`Lun`,`Mar`,`Mié`,`Jue`,`Vie`,`Sáb`].map(e=>(0,k.jsx)(`div`,{className:`weekday-name-label`,children:e},e))}),(0,k.jsx)(`div`,{className:`calendar-grid-body`,children:b().map((e,t)=>{let n=e.dateStr===new Date().toISOString().split(`T`)[0],r=x(e.dateStr);return(0,k.jsxs)(`div`,{className:`calendar-day-slot ${e.day?`filled-slot`:`empty-slot`} ${n?`today-slot`:``}`,children:[e.day&&(0,k.jsx)(`div`,{className:`day-number-wrapper`,children:(0,k.jsx)(`span`,{className:`day-number-label`,children:e.day})}),e.day&&r.length>0&&(0,k.jsx)(`div`,{className:`day-events-list`,children:r.map((e,t)=>(0,k.jsx)(`button`,{onClick:()=>ee(e.cert),className:`calendar-event-badge event-type-${e.type}`,title:e.title,children:e.title},t))})]},t)})})]}),(0,k.jsx)(`dialog`,{ref:f,className:`cert-dialog-modal glass-card`,onClose:S,children:c&&(0,k.jsxs)(`div`,{className:`modal-content-wrapper`,children:[(0,k.jsxs)(`div`,{className:`modal-header`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h2`,{children:c.employeeName}),(0,k.jsxs)(`p`,{className:`modal-subtitle`,children:[`ID de Certificado: `,c.id]})]}),(0,k.jsx)(`button`,{className:`close-modal-btn`,onClick:S,"aria-label":`Cerrar Modal`,children:(0,k.jsx)(Ne,{size:24})})]}),(0,k.jsxs)(`div`,{className:`modal-body-grid`,children:[(0,k.jsx)(`div`,{className:`modal-document-viewer`,children:c.imageType===`application/pdf`?(0,k.jsxs)(`div`,{className:`pdf-viewer-placeholder`,children:[(0,k.jsx)(ge,{size:100,className:`pdf-modal-icon`}),(0,k.jsx)(`h4`,{children:`Documento PDF`}),(0,k.jsx)(`p`,{children:c.imageName}),(0,k.jsx)(`a`,{href:u,download:c.imageName,className:`btn btn-secondary mt-4`,children:`Descargar PDF`})]}):u?(0,k.jsx)(`img`,{src:u,alt:`Escaneo del Certificado`,className:`modal-image-display`}):(0,k.jsx)(`div`,{className:`no-image-placeholder`,children:`No se adjuntó ningún archivo de documento.`})}),(0,k.jsxs)(`div`,{className:`modal-metadata-section`,children:[(0,k.jsxs)(`div`,{className:`meta-card`,children:[(0,k.jsx)(`h3`,{children:`Resumen de Cumplimiento`}),(0,k.jsxs)(`div`,{className:`meta-detail-row`,children:[(0,k.jsx)(`span`,{className:`meta-label`,children:`Estado`}),(0,k.jsx)(`span`,{className:`badge badge-${c.status}`,children:c.status===`active`?`Activo`:c.status===`expiring`?`Vence Pronto`:`Vencido`})]}),(0,k.jsxs)(`div`,{className:`meta-detail-row`,children:[(0,k.jsx)(`span`,{className:`meta-label`,children:`Fecha de Emisión`}),(0,k.jsx)(`span`,{className:`meta-value`,children:c.issueDate})]}),(0,k.jsxs)(`div`,{className:`meta-detail-row`,children:[(0,k.jsx)(`span`,{className:`meta-label`,children:`Fecha de Vencimiento`}),(0,k.jsx)(`span`,{className:`meta-value`,children:c.expirationDate?c.expirationDate:`Indefinido`})]}),(0,k.jsxs)(`div`,{className:`meta-actions`,children:[c.expirationDate&&(0,k.jsxs)(`button`,{className:`btn btn-primary`,onClick:()=>qe(c),children:[(0,k.jsx)(O,{size:16}),` Exportar Recordatorio (.ics)`]}),(0,k.jsxs)(`button`,{className:`btn btn-danger`,onClick:()=>C(c.id),children:[(0,k.jsx)(ke,{size:16}),` Eliminar Registro`]})]})]}),(0,k.jsxs)(`div`,{className:`meta-card alert-history`,children:[(0,k.jsx)(`h3`,{children:`Historial de Alertas`}),o.filter(e=>e.certificateId===c.id).length===0?(0,k.jsx)(`p`,{className:`no-alerts-text`,children:`No se han activado alertas.`}):(0,k.jsx)(`ul`,{className:`alert-list-trail`,children:o.filter(e=>e.certificateId===c.id).map(e=>(0,k.jsxs)(`li`,{className:`alert-trail-item`,children:[(0,k.jsxs)(`div`,{className:`alert-item-header`,children:[(0,k.jsx)(`span`,{className:`alert-type`,children:e.type===`warning-14day`?`Aviso de 2 semanas`:`Alerta de Vencimiento`}),(0,k.jsx)(`span`,{className:`alert-timestamp`,children:new Date(e.sentAt).toLocaleDateString()})]}),(0,k.jsxs)(`p`,{className:`alert-details-desc`,children:[`Enviado a: `,e.recipient,`. Estado: Enviado`]})]},e.id))})]})]})]})]})}),(0,k.jsx)(`style`,{children:`
      ...
      `})]})}function Qe({refreshTrigger:e}){let[t,n]=(0,_.useState)([]),[r,i]=(0,_.useState)([]),[a,o]=(0,_.useState)(``),[s,c]=(0,_.useState)(!0),[l,u]=(0,_.useState)(null),[d,f]=(0,_.useState)(``),p=(0,_.useRef)(null);(0,_.useEffect)(()=>{m()},[e]),(0,_.useEffect)(()=>{if(a.trim()===``)i(t);else{let e=a.toLowerCase();i(t.filter(t=>t.employeeName.toLowerCase().includes(e)))}},[a,t]);let m=async()=>{c(!0);try{let e=await Ge();n(e),i(e)}catch(e){console.error(`Failed to load notification logs:`,e)}finally{c(!1)}},h=async e=>{try{let t=await He(e);t?(u(t),t.imageBlob?f(URL.createObjectURL(t.imageBlob)):f(``),p.current&&p.current.showModal()):alert(`Archivo de certificado no encontrado (podría haber sido eliminado).`)}catch(e){console.error(e),alert(`Error al cargar el certificado.`)}},g=()=>{p.current&&p.current.close(),u(null),d&&(URL.revokeObjectURL(d),f(``))},v=async e=>{if(window.confirm(`¿Está seguro de que desea eliminar este registro de certificado?`))try{await A(e),g(),m()}catch(e){console.error(e)}};return(0,k.jsxs)(`div`,{className:`logs-container animate-fade-in`,children:[(0,k.jsxs)(`div`,{className:`view-header`,children:[(0,k.jsx)(`h2`,{className:`view-title`,children:`Historial de Notificaciones`}),(0,k.jsx)(`p`,{className:`view-subtitle`,children:`Registro de las notificaciones de cumplimiento enviadas por correo electrónico.`})]}),(0,k.jsx)(`div`,{className:`glass-card control-bar`,children:(0,k.jsxs)(`div`,{className:`search-box`,children:[(0,k.jsx)(we,{size:18,className:`search-icon`}),(0,k.jsx)(`input`,{type:`text`,className:`search-input`,placeholder:`Filtrar por nombre de empleado...`,value:a,onChange:e=>o(e.target.value)})]})}),s?(0,k.jsxs)(`div`,{className:`loading-state-logs`,children:[(0,k.jsx)(`div`,{className:`spinner`}),(0,k.jsx)(`p`,{children:`Cargando el registro de auditoría...`})]}):r.length===0?(0,k.jsxs)(`div`,{className:`glass-card empty-logs-state`,children:[(0,k.jsx)(ae,{size:64,className:`empty-icon`}),(0,k.jsx)(`h3`,{children:`No se Enviaron Notificaciones`}),(0,k.jsx)(`p`,{children:`Las notificaciones se generan automáticamente cuando los certificados se acercan a su fecha de vencimiento.`})]}):(0,k.jsx)(`div`,{className:`glass-card table-card`,children:(0,k.jsx)(`div`,{className:`table-responsive`,children:(0,k.jsxs)(`table`,{className:`audit-table`,children:[(0,k.jsx)(`thead`,{children:(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`th`,{children:`Empleado`}),(0,k.jsx)(`th`,{children:`Tipo de Notificación`}),(0,k.jsx)(`th`,{children:`Destinatario`}),(0,k.jsx)(`th`,{children:`Fecha de Envío`}),(0,k.jsx)(`th`,{children:`Vencimiento`}),(0,k.jsx)(`th`,{children:`Estado`}),(0,k.jsx)(`th`,{className:`actions-header`,children:`Acceso al Archivo`})]})}),(0,k.jsx)(`tbody`,{children:r.map(e=>(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(`span`,{className:`emp-name-cell`,children:e.employeeName})}),(0,k.jsx)(`td`,{children:(0,k.jsxs)(`div`,{className:`notif-type-cell`,children:[(0,k.jsx)(ye,{size:14,className:`cell-icon`}),(0,k.jsx)(`span`,{children:e.type===`warning-14day`?`Aviso de 2 semanas`:`Alerta de Vencimiento`})]})}),(0,k.jsx)(`td`,{children:(0,k.jsx)(`code`,{className:`email-badge`,children:e.recipient})}),(0,k.jsx)(`td`,{children:new Date(e.sentAt).toLocaleString()}),(0,k.jsx)(`td`,{children:e.expirationDate||`Indefinido`}),(0,k.jsx)(`td`,{children:(0,k.jsx)(`span`,{className:`status-indicator-sent`,children:`Enviado`})}),(0,k.jsx)(`td`,{className:`actions-cell`,children:(0,k.jsxs)(`button`,{className:`btn btn-secondary py-1 px-3 btn-small`,onClick:()=>h(e.certificateId),children:[(0,k.jsx)(he,{size:14}),` Ver Doc`]})})]},e.id))})]})})}),(0,k.jsx)(`dialog`,{ref:p,className:`cert-dialog-modal glass-card`,onClose:g,children:l&&(0,k.jsxs)(`div`,{className:`modal-content-wrapper`,children:[(0,k.jsxs)(`div`,{className:`modal-header`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h2`,{children:l.employeeName}),(0,k.jsxs)(`p`,{className:`modal-subtitle`,children:[`ID de Certificado: `,l.id]})]}),(0,k.jsx)(`button`,{className:`close-modal-btn`,onClick:g,"aria-label":`Cerrar Modal`,children:(0,k.jsx)(Ne,{size:24})})]}),(0,k.jsxs)(`div`,{className:`modal-body-grid`,children:[(0,k.jsx)(`div`,{className:`modal-document-viewer`,children:l.imageType===`application/pdf`?(0,k.jsxs)(`div`,{className:`pdf-viewer-placeholder`,children:[(0,k.jsx)(ge,{size:100,className:`pdf-modal-icon`}),(0,k.jsx)(`h4`,{children:`Documento PDF`}),(0,k.jsx)(`p`,{children:l.imageName}),(0,k.jsx)(`a`,{href:d,download:l.imageName,className:`btn btn-secondary mt-4`,children:`Descargar PDF`})]}):d?(0,k.jsx)(`img`,{src:d,alt:`Escaneo del Certificado`,className:`modal-image-display`}):(0,k.jsx)(`div`,{className:`no-image-placeholder`,children:`No se adjuntó ningún archivo de documento.`})}),(0,k.jsx)(`div`,{className:`modal-metadata-section`,children:(0,k.jsxs)(`div`,{className:`meta-card`,children:[(0,k.jsx)(`h3`,{children:`Resumen de Cumplimiento`}),(0,k.jsxs)(`div`,{className:`meta-detail-row`,children:[(0,k.jsx)(`span`,{className:`meta-label`,children:`Estado`}),(0,k.jsx)(`span`,{className:`badge badge-${l.status}`,children:l.status===`active`?`Activo`:l.status===`expiring`?`Vence Pronto`:`Vencido`})]}),(0,k.jsxs)(`div`,{className:`meta-detail-row`,children:[(0,k.jsx)(`span`,{className:`meta-label`,children:`Fecha de Emisión`}),(0,k.jsx)(`span`,{className:`meta-value`,children:l.issueDate})]}),(0,k.jsxs)(`div`,{className:`meta-detail-row`,children:[(0,k.jsx)(`span`,{className:`meta-label`,children:`Fecha de Vencimiento`}),(0,k.jsx)(`span`,{className:`meta-value`,children:l.expirationDate?l.expirationDate:`Indefinido`})]}),(0,k.jsxs)(`div`,{className:`meta-actions`,children:[l.expirationDate&&(0,k.jsxs)(`button`,{className:`btn btn-primary`,onClick:()=>qe(l),children:[(0,k.jsx)(O,{size:16}),` Exportar Recordatorio (.ics)`]}),(0,k.jsxs)(`button`,{className:`btn btn-danger`,onClick:()=>v(l.id),children:[(0,k.jsx)(ke,{size:16}),` Eliminar Registro`]})]})]})})]})]})}),(0,k.jsx)(`style`,{children:`
        .logs-container {
          max-width: 1200px;
          margin: 0 auto;
          width: 100%;
      ...
      `})]})}function $e({onDataReset:e}){let[t,n]=(0,_.useState)(`1year`),[r,i]=(0,_.useState)(14),[a,o]=(0,_.useState)(`hr@company.com`),[s,c]=(0,_.useState)({text:``,type:``}),[l,u]=(0,_.useState)(!1);return(0,_.useEffect)(()=>{n(localStorage.getItem(`default_validity`)||`1year`),i(parseInt(localStorage.getItem(`warning_period`)||`14`,10)),o(localStorage.getItem(`notification_recipient`)||`hr@company.com`)},[]),(0,k.jsxs)(`div`,{className:`settings-container animate-fade-in`,children:[(0,k.jsxs)(`div`,{className:`view-header`,children:[(0,k.jsx)(`h2`,{className:`view-title`,children:`Configuración del Sistema`}),(0,k.jsx)(`p`,{className:`view-subtitle`,children:`Configure las reglas de alerta de vencimiento, los periodos de validez predeterminados y gestione la base de datos local.`})]}),s.text&&(0,k.jsx)(`div`,{className:`alert-banner ${s.type===`success`?`alert-success`:`alert-error`}`,children:s.text}),(0,k.jsxs)(`div`,{className:`settings-grid`,children:[(0,k.jsxs)(`section`,{className:`glass-card settings-card`,children:[(0,k.jsxs)(`div`,{className:`card-header-icon`,children:[(0,k.jsx)(se,{className:`cyan-glow-icon`,size:24}),(0,k.jsx)(`h3`,{children:`Reglas de Cumplimiento y Alertas`})]}),(0,k.jsx)(`p`,{className:`settings-description`,children:`Defina las reglas de negocio globales para determinar las fechas de vencimiento y activar las alertas de RRHH.`}),(0,k.jsxs)(`form`,{onSubmit:e=>{e.preventDefault(),localStorage.setItem(`default_validity`,t),localStorage.setItem(`warning_period`,r.toString()),localStorage.setItem(`notification_recipient`,a),c({text:`¡Configuración guardada con éxito!`,type:`success`}),setTimeout(()=>c({text:``,type:``}),3e3)},children:[(0,k.jsxs)(`div`,{className:`form-row`,children:[(0,k.jsxs)(`div`,{className:`form-group flex-1`,children:[(0,k.jsx)(`label`,{className:`form-label`,htmlFor:`default-validity-select`,children:`Periodo de Validez Predeterminado`}),(0,k.jsxs)(`select`,{id:`default-validity-select`,className:`form-input`,value:t,onChange:e=>n(e.target.value),children:[(0,k.jsx)(`option`,{value:`1year`,children:`1 Año (Estándar)`}),(0,k.jsx)(`option`,{value:`2years`,children:`2 Años (Extendido)`}),(0,k.jsx)(`option`,{value:`none`,children:`Sin valor predeterminado (Requerir fecha explícita)`})]})]}),(0,k.jsxs)(`div`,{className:`form-group flex-1`,children:[(0,k.jsx)(`label`,{className:`form-label`,htmlFor:`warning-period-input`,children:`Periodo de Advertencia (Días)`}),(0,k.jsx)(`input`,{type:`number`,id:`warning-period-input`,className:`form-input`,min:`1`,max:`120`,value:r,onChange:e=>i(Math.max(1,parseInt(e.target.value,10)))})]})]}),(0,k.jsxs)(`div`,{className:`form-group`,children:[(0,k.jsx)(`label`,{className:`form-label`,htmlFor:`recipient-input`,children:`Destinatario de Notificaciones de RRHH`}),(0,k.jsx)(`input`,{type:`email`,id:`recipient-input`,className:`form-input`,placeholder:`hr@company.com`,value:a,onChange:e=>o(e.target.value),required:!0})]}),(0,k.jsxs)(`button`,{type:`submit`,className:`btn btn-primary`,children:[(0,k.jsx)(Ce,{size:18}),`Guardar Reglas del Sistema`]})]})]}),(0,k.jsxs)(`section`,{className:`glass-card settings-card span-two-cols`,children:[(0,k.jsxs)(`div`,{className:`card-header-icon`,children:[(0,k.jsx)(D,{className:`cyan-glow-icon`,size:24}),(0,k.jsx)(`h3`,{children:`Controles de la Base de Datos Local`})]}),(0,k.jsx)(`p`,{className:`settings-description`,children:`Sus datos se almacenan 100% de forma local en el navegador (IndexedDB). Limpie la base de datos para eliminar todos los registros o cargue un conjunto de datos demo estructurado.`}),(0,k.jsxs)(`div`,{className:`settings-actions`,children:[(0,k.jsxs)(`button`,{onClick:async()=>{u(!0);try{let t=await ze();for(let e of t)await A(e.id);let n=new Date,r=e=>{let t=new Date(n);return t.setDate(t.getDate()+e),t.toISOString().split(`T`)[0]},i=atob(`iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=`),o=Array(i.length);for(let e=0;e<i.length;e++)o[e]=i.charCodeAt(e);let s=new Uint8Array(o),l=new Blob([s],{type:`image/png`}),u=[{id:`cert_1`,employeeName:`Sofía Jiménez`,issueDate:r(-100),expirationDate:r(265),businessRule:`1year`,uploadedAt:r(-100),imageBlob:l,imageName:`sofia_jimenez_certificado_salud.png`,imageType:`image/png`},{id:`cert_2`,employeeName:`Daniel Martínez`,issueDate:r(-30),expirationDate:r(700),businessRule:`2years`,uploadedAt:r(-30),imageBlob:l,imageName:`daniel_martinez_alta_medica.png`,imageType:`image/png`},{id:`cert_3`,employeeName:`Elena Rodríguez`,issueDate:r(-355),expirationDate:r(10),businessRule:`1year`,uploadedAt:r(-355),imageBlob:l,imageName:`elena_rodriguez_certificado_2026.png`,imageType:`image/png`},{id:`cert_4`,employeeName:`Marcos Vargas`,issueDate:r(-380),expirationDate:r(-15),businessRule:`1year`,uploadedAt:r(-380),imageBlob:l,imageName:`marcos_vargas_evaluacion_medica.png`,imageType:`image/png`},{id:`cert_5`,employeeName:`Diana Pérez`,issueDate:r(-200),expirationDate:``,businessRule:`none`,uploadedAt:r(-200),imageBlob:l,imageName:`diana_perez_declaracion_salud.png`,imageType:`image/png`}];for(let e of u)await Ue(e);await We({certificateId:`cert_4`,employeeName:`Marcos Vargas`,recipient:a,type:`warning-14day`,sentAt:new Date(n.getTime()-696*60*60*1e3).toISOString(),expirationDate:r(-15),status:`Sent`}),await We({certificateId:`cert_4`,employeeName:`Marcos Vargas`,recipient:a,type:`expired-alert`,sentAt:new Date(n.getTime()-360*60*60*1e3).toISOString(),expirationDate:r(-15),status:`Sent`}),await We({certificateId:`cert_3`,employeeName:`Elena Rodríguez`,recipient:a,type:`warning-14day`,sentAt:new Date(n.getTime()-5760*60*1e3).toISOString(),expirationDate:r(10),status:`Sent`}),c({text:`¡Datos demo cargados con éxito!`,type:`success`}),e&&e()}catch(e){console.error(e),c({text:`Error al cargar datos demo: `+e.message,type:`error`})}finally{u(!1),setTimeout(()=>c({text:``,type:``}),4e3)}},disabled:l,className:`btn btn-secondary`,children:[(0,k.jsx)(De,{className:`green-text`,size:18}),l?`Reiniciando...`:`Cargar Datos de Demostración`]}),(0,k.jsxs)(`button`,{onClick:async()=>{if(window.confirm(`¿Está completamente seguro de que desea eliminar todos los datos y registros de certificados? Esta acción es irreversible.`)){u(!0);try{let t=await ze();for(let e of t)await A(e.id);c({text:`Se han eliminado todos los datos.`,type:`success`}),e&&e()}catch(e){c({text:`Error al eliminar datos: `+e.message,type:`error`})}finally{u(!1),setTimeout(()=>c({text:``,type:``}),4e3)}}},disabled:l,className:`btn btn-danger`,children:[(0,k.jsx)(ke,{size:18}),l?`Eliminando...`:`Limpiar Base de Datos`]})]})]})]}),(0,k.jsx)(`style`,{children:`
        .settings-container {
          max-width: 1000px;
          margin: 0 auto;
          width: 100%;
